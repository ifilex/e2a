...
void genArithRR(struct GenData* data, const char* op, const char* flags, const char* bits, const char* r1, const char* r2, U32 useResult, U32 useCF, const char* cycles) {
    if (useCF) {
        out(data, "cpu->oldcf = ");
...
void genArithRR_noflags(struct GenData* data, const char* op, const char* bits, const char* r1, const char* r2, U32 useCF, const char* cycles) {
    out(data, r1);
    out(data, " = ");
    out(data, r1);
    out(data, " ");
...
void genArithER(struct GenData* data, const char* op, const char* flags, const char* bits, const char* address, const char* memWidth, const char* r1, U32 useResult, U32 useCF, const char* cycles) {
    if (useCF) {
        out(data, "cpu->oldcf = ");
        out(data, getFlag(data, CF));
        out(data, ";");
...
void genArithER_noflags(struct GenData* data, const char* op, const char* bits, const char* address, const char* memWidth, const char* r1, U32 useCF, const char* cycles) {
    out(data, "eaa = ");
    out(data, address);
    out(data, "; write");
    out(data, memWidth);
...
void genArithRE(struct GenData* data, const char* op, const char* flags, const char* bits, const char* address, const char* memWidth, const char* r1, U32 useResult, U32 useCF, const char* cycles) {
    if (useCF) {
        out(data, "cpu->oldcf = ");
        out(data, getFlag(data, CF));
        out(data, ";");
...
void genArithRE_noflags(struct GenData* data, const char* op, const char* bits, const char* address, const char* memWidth, const char* r1, U32 useCF, const char* cycles) {
    out(data, r1);
    out(data, " = ");
    out(data, r1);
    out(data, " ");
...
void genArithR(struct GenData* data, const char* op, const char* flags, const char* bits, const char* r1, unsigned int value, U32 useResult, U32 useCF, const char* cycles) {
    char tmp[16];
...
void genArithR_noflags(struct GenData* data, const char* op, const char* bits, const char* r1, unsigned int value, U32 useCF, const char* cycles) {
    char tmp[16];
...
void gen000(struct GenData* data, struct Op* op) {
    if (op->func==addr8r8) {
        genArithRR(data, "+", "FLAGS_ADD8", "8", r8(op->r1), r8(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_ADD8;
    } else if (op->func==addr8r8_noflags) {
        genArithRR_noflags(data, "+", "8", r8(op->r1), r8(op->r2), 0,"1");
    } else if (op->func==adde8r8_16) {
        genArithER(data, "+", "FLAGS_ADD8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_ADD8;
    } else if (op->func==adde8r8_16_noflags) {
        genArithER_noflags(data, "+", "8", getEaa16(op), "b", r8(op->r1), 0,"3");
    } else if (op->func==adde8r8_32) {
        genArithER(data, "+", "FLAGS_ADD8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_ADD8;
    } else if (op->func==adde8r8_32_noflags) {
        genArithER_noflags(data, "+", "8", getEaa32(op), "b", r8(op->r1), 0,"3");
    }
}
...
void gen001(struct GenData* data, struct Op* op) {
    if (op->func==addr16r16) {
        genArithRR(data, "+", "FLAGS_ADD16", "16", r16(op->r1), r16(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_ADD16;
    } else if (op->func==addr16r16_noflags) {
        genArithRR_noflags(data, "+", "16", r16(op->r1), r16(op->r2), 0,"1");
    } else if (op->func==adde16r16_16) {
        genArithER(data, "+", "FLAGS_ADD16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_ADD16;
    } else if (op->func==adde16r16_16_noflags) {
        genArithER_noflags(data, "+", "16", getEaa16(op), "w", r16(op->r1), 0,"3");
    } else if (op->func==adde16r16_32) {
        genArithER(data, "+", "FLAGS_ADD16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_ADD16;
    } else if (op->func==adde16r16_32_noflags) {
        genArithER_noflags(data, "+", "16", getEaa32(op), "w", r16(op->r1), 0,"3");
    }
}
...
void gen201(struct GenData* data, struct Op* op) {
    if (op->func==addr32r32) {
        genArithRR(data, "+", "FLAGS_ADD32", "32", r32(op->r1), r32(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_ADD32;
    } else if (op->func==addr32r32_noflags) {
        genArithRR_noflags(data, "+", "32", r32(op->r1), r32(op->r2), 0,"1");
    } else if (op->func==adde32r32_16) {
        genArithER(data, "+", "FLAGS_ADD32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_ADD32;
    } else if (op->func==adde32r32_16_noflags) {
        genArithER_noflags(data, "+", "32", getEaa16(op), "d", r32(op->r1), 0,"3");
    } else if (op->func==adde32r32_32) {
        genArithER(data, "+", "FLAGS_ADD32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_ADD32;
    } else if (op->func==adde32r32_32_noflags) {
        genArithER_noflags(data, "+", "32", getEaa32(op), "d", r32(op->r1), 0,"3");
    }
}
void OPCALL addr8r8(struct CPU* cpu, struct Op* op);
void OPCALL addr8r8_noflags(struct CPU* cpu, struct Op* op);
...
void gen002(struct GenData* data, struct Op* op) {
    if (op->func==addr8r8) {
        ...
        genArithRE(data, "+", "FLAGS_ADD8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_ADD8;
    } else if (op->func==addr8e8_16_noflags) {
        genArithRE_noflags(data, "+", "8", getEaa16(op), "b", r8(op->r1), 0,"2");
    } else if (op->func==addr8e8_32) {
        genArithRE(data, "+", "FLAGS_ADD8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_ADD8;
    } else if (op->func==addr8e8_32_noflags) {
        genArithRE_noflags(data, "+", "8", getEaa32(op), "b", r8(op->r1), 0,"2");
    }
}
void OPCALL addr16r16(struct CPU* cpu, struct Op* op);
void OPCALL addr16r16_noflags(struct CPU* cpu, struct Op* op);
...
void gen003(struct GenData* data, struct Op* op) {
    if (op->func==addr16r16) {
        ...
        genArithRE(data, "+", "FLAGS_ADD16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_ADD16;
    } else if (op->func==addr16e16_16_noflags) {
        genArithRE_noflags(data, "+", "16", getEaa16(op), "w", r16(op->r1), 0,"2");
    } else if (op->func==addr16e16_32) {
        genArithRE(data, "+", "FLAGS_ADD16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_ADD16;
    } else if (op->func==addr16e16_32_noflags) {
        genArithRE_noflags(data, "+", "16", getEaa32(op), "w", r16(op->r1), 0,"2");
    }
}
void OPCALL addr32r32(struct CPU* cpu, struct Op* op);
void OPCALL addr32r32_noflags(struct CPU* cpu, struct Op* op);
...
void gen203(struct GenData* data, struct Op* op) {
    if (op->func==addr32r32) {
        ...
        genArithRE(data, "+", "FLAGS_ADD32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_ADD32;
    } else if (op->func==addr32e32_16_noflags) {
        genArithRE_noflags(data, "+", "32", getEaa16(op), "d", r32(op->r1), 0,"2");
    } else if (op->func==addr32e32_32) {
        genArithRE(data, "+", "FLAGS_ADD32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_ADD32;
    } else if (op->func==addr32e32_32_noflags) {
        genArithRE_noflags(data, "+", "32", getEaa32(op), "d", r32(op->r1), 0,"2");
    }
}
...
void gen008(struct GenData* data, struct Op* op) {
    if (op->func==orr8r8) {
        genArithRR(data, "|", "FLAGS_OR8", "8", r8(op->r1), r8(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_OR8;
    } else if (op->func==orr8r8_noflags) {
        genArithRR_noflags(data, "|", "8", r8(op->r1), r8(op->r2), 0,"1");
    } else if (op->func==ore8r8_16) {
        genArithER(data, "|", "FLAGS_OR8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_OR8;
    } else if (op->func==ore8r8_16_noflags) {
        genArithER_noflags(data, "|", "8", getEaa16(op), "b", r8(op->r1), 0,"3");
    } else if (op->func==ore8r8_32) {
        genArithER(data, "|", "FLAGS_OR8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_OR8;
...
void gen009(struct GenData* data, struct Op* op) {
    if (op->func==orr16r16) {
        genArithRR(data, "|", "FLAGS_OR16", "16", r16(op->r1), r16(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_OR16;
    } else if (op->func==orr16r16_noflags) {
        genArithRR_noflags(data, "|", "16", r16(op->r1), r16(op->r2), 0,"1");
    } else if (op->func==ore16r16_16) {
        genArithER(data, "|", "FLAGS_OR16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_OR16;
    } else if (op->func==ore16r16_16_noflags) {
        genArithER_noflags(data, "|", "16", getEaa16(op), "w", r16(op->r1), 0,"3");
    } else if (op->func==ore16r16_32) {
        genArithER(data, "|", "FLAGS_OR16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_OR16;
...
void gen209(struct GenData* data, struct Op* op) {
    if (op->func==orr32r32) {
        genArithRR(data, "|", "FLAGS_OR32", "32", r32(op->r1), r32(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_OR32;
    } else if (op->func==orr32r32_noflags) {
        genArithRR_noflags(data, "|", "32", r32(op->r1), r32(op->r2), 0,"1");
    } else if (op->func==ore32r32_16) {
        genArithER(data, "|", "FLAGS_OR32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_OR32;
    } else if (op->func==ore32r32_16_noflags) {
        genArithER_noflags(data, "|", "32", getEaa16(op), "d", r32(op->r1), 0,"3");
    } else if (op->func==ore32r32_32) {
        genArithER(data, "|", "FLAGS_OR32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_OR32;
...
void gen00a(struct GenData* data, struct Op* op) {
    if (op->func==orr8r8) {
        ...
        genArithRE(data, "|", "FLAGS_OR8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_OR8;
    } else if (op->func==orr8e8_16_noflags) {
        genArithRE_noflags(data, "|", "8", getEaa16(op), "b", r8(op->r1), 0,"2");
    } else if (op->func==orr8e8_32) {
        genArithRE(data, "|", "FLAGS_OR8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_OR8;
...
void gen00b(struct GenData* data, struct Op* op) {
    if (op->func==orr16r16) {
        ...
        genArithRE(data, "|", "FLAGS_OR16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_OR16;
    } else if (op->func==orr16e16_16_noflags) {
        genArithRE_noflags(data, "|", "16", getEaa16(op), "w", r16(op->r1), 0,"2");
    } else if (op->func==orr16e16_32) {
        genArithRE(data, "|", "FLAGS_OR16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_OR16;
...
void gen20b(struct GenData* data, struct Op* op) {
    if (op->func==orr32r32) {
        ...
        genArithRE(data, "|", "FLAGS_OR32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_OR32;
    } else if (op->func==orr32e32_16_noflags) {
        genArithRE_noflags(data, "|", "32", getEaa16(op), "d", r32(op->r1), 0,"2");
    } else if (op->func==orr32e32_32) {
        genArithRE(data, "|", "FLAGS_OR32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_OR32;
...
void gen010(struct GenData* data, struct Op* op) {
    if (op->func==adcr8r8) {
        genArithRR(data, "+", "FLAGS_ADC8", "8", r8(op->r1), r8(op->r2), 1, 1,"1");
        data->lazyFlags = sFLAGS_ADC8;
    } else if (op->func==adcr8r8_noflags) {
        genArithRR_noflags(data, "+", "8", r8(op->r1), r8(op->r2), 1,"1");
    } else if (op->func==adce8r8_16) {
        genArithER(data, "+", "FLAGS_ADC8", "8", getEaa16(op), "b", r8(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_ADC8;
    } else if (op->func==adce8r8_16_noflags) {
        genArithER_noflags(data, "+", "8", getEaa16(op), "b", r8(op->r1), 1,"3");
    } else if (op->func==adce8r8_32) {
        genArithER(data, "+", "FLAGS_ADC8", "8", getEaa32(op), "b", r8(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_ADC8;
    } else if (op->func==adce8r8_32_noflags) {
        genArithER_noflags(data, "+", "8", getEaa32(op), "b", r8(op->r1), 1,"3");
    }
}
...
void gen011(struct GenData* data, struct Op* op) {
    if (op->func==adcr16r16) {
        genArithRR(data, "+", "FLAGS_ADC16", "16", r16(op->r1), r16(op->r2), 1, 1,"1");
        data->lazyFlags = sFLAGS_ADC16;
    } else if (op->func==adcr16r16_noflags) {
        genArithRR_noflags(data, "+", "16", r16(op->r1), r16(op->r2), 1,"1");
    } else if (op->func==adce16r16_16) {
        genArithER(data, "+", "FLAGS_ADC16", "16", getEaa16(op), "w", r16(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_ADC16;
    } else if (op->func==adce16r16_16_noflags) {
        genArithER_noflags(data, "+", "16", getEaa16(op), "w", r16(op->r1), 1,"3");
    } else if (op->func==adce16r16_32) {
        genArithER(data, "+", "FLAGS_ADC16", "16", getEaa32(op), "w", r16(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_ADC16;
    } else if (op->func==adce16r16_32_noflags) {
        genArithER_noflags(data, "+", "16", getEaa32(op), "w", r16(op->r1), 1,"3");
    }
}
...
void gen211(struct GenData* data, struct Op* op) {
    if (op->func==adcr32r32) {
        genArithRR(data, "+", "FLAGS_ADC32", "32", r32(op->r1), r32(op->r2), 1, 1,"1");
        data->lazyFlags = sFLAGS_ADC32;
    } else if (op->func==adcr32r32_noflags) {
        genArithRR_noflags(data, "+", "32", r32(op->r1), r32(op->r2), 1,"1");
    } else if (op->func==adce32r32_16) {
        genArithER(data, "+", "FLAGS_ADC32", "32", getEaa16(op), "d", r32(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_ADC32;
    } else if (op->func==adce32r32_16_noflags) {
        genArithER_noflags(data, "+", "32", getEaa16(op), "d", r32(op->r1), 1,"3");
    } else if (op->func==adce32r32_32) {
        genArithER(data, "+", "FLAGS_ADC32", "32", getEaa32(op), "d", r32(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_ADC32;
    } else if (op->func==adce32r32_32_noflags) {
        genArithER_noflags(data, "+", "32", getEaa32(op), "d", r32(op->r1), 1,"3");
    }
}
void OPCALL adcr8r8(struct CPU* cpu, struct Op* op);
void OPCALL adcr8r8_noflags(struct CPU* cpu, struct Op* op);
...
void gen012(struct GenData* data, struct Op* op) {
    if (op->func==adcr8r8) {
        ...
        genArithRE(data, "+", "FLAGS_ADC8", "8", getEaa16(op), "b", r8(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_ADC8;
    } else if (op->func==adcr8e8_16_noflags) {
        genArithRE_noflags(data, "+", "8", getEaa16(op), "b", r8(op->r1), 1,"2");
    } else if (op->func==adcr8e8_32) {
        genArithRE(data, "+", "FLAGS_ADC8", "8", getEaa32(op), "b", r8(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_ADC8;
    } else if (op->func==adcr8e8_32_noflags) {
        genArithRE_noflags(data, "+", "8", getEaa32(op), "b", r8(op->r1), 1,"2");
    }
}
void OPCALL adcr16r16(struct CPU* cpu, struct Op* op);
void OPCALL adcr16r16_noflags(struct CPU* cpu, struct Op* op);
...
void gen013(struct GenData* data, struct Op* op) {
    if (op->func==adcr16r16) {
        ...
        genArithRE(data, "+", "FLAGS_ADC16", "16", getEaa16(op), "w", r16(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_ADC16;
    } else if (op->func==adcr16e16_16_noflags) {
        genArithRE_noflags(data, "+", "16", getEaa16(op), "w", r16(op->r1), 1,"2");
    } else if (op->func==adcr16e16_32) {
        genArithRE(data, "+", "FLAGS_ADC16", "16", getEaa32(op), "w", r16(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_ADC16;
    } else if (op->func==adcr16e16_32_noflags) {
        genArithRE_noflags(data, "+", "16", getEaa32(op), "w", r16(op->r1), 1,"2");
    }
}
void OPCALL adcr32r32(struct CPU* cpu, struct Op* op);
void OPCALL adcr32r32_noflags(struct CPU* cpu, struct Op* op);
...
void gen213(struct GenData* data, struct Op* op) {
    if (op->func==adcr32r32) {
        ...
        genArithRE(data, "+", "FLAGS_ADC32", "32", getEaa16(op), "d", r32(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_ADC32;
    } else if (op->func==adcr32e32_16_noflags) {
        genArithRE_noflags(data, "+", "32", getEaa16(op), "d", r32(op->r1), 1,"2");
    } else if (op->func==adcr32e32_32) {
        genArithRE(data, "+", "FLAGS_ADC32", "32", getEaa32(op), "d", r32(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_ADC32;
    } else if (op->func==adcr32e32_32_noflags) {
        genArithRE_noflags(data, "+", "32", getEaa32(op), "d", r32(op->r1), 1,"2");
    }
}
...
void gen018(struct GenData* data, struct Op* op) {
    if (op->func==sbbr8r8) {
        genArithRR(data, "-", "FLAGS_SBB8", "8", r8(op->r1), r8(op->r2), 1, 1,"1");
        data->lazyFlags = sFLAGS_SBB8;
    } else if (op->func==sbbr8r8_noflags) {
        genArithRR_noflags(data, "-", "8", r8(op->r1), r8(op->r2), 1,"1");
    } else if (op->func==sbbe8r8_16) {
        genArithER(data, "-", "FLAGS_SBB8", "8", getEaa16(op), "b", r8(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_SBB8;
    } else if (op->func==sbbe8r8_16_noflags) {
        genArithER_noflags(data, "-", "8", getEaa16(op), "b", r8(op->r1), 1,"3");
    } else if (op->func==sbbe8r8_32) {
        genArithER(data, "-", "FLAGS_SBB8", "8", getEaa32(op), "b", r8(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_SBB8;
...
void gen019(struct GenData* data, struct Op* op) {
    if (op->func==sbbr16r16) {
        genArithRR(data, "-", "FLAGS_SBB16", "16", r16(op->r1), r16(op->r2), 1, 1,"1");
        data->lazyFlags = sFLAGS_SBB16;
    } else if (op->func==sbbr16r16_noflags) {
        genArithRR_noflags(data, "-", "16", r16(op->r1), r16(op->r2), 1,"1");
    } else if (op->func==sbbe16r16_16) {
        genArithER(data, "-", "FLAGS_SBB16", "16", getEaa16(op), "w", r16(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_SBB16;
    } else if (op->func==sbbe16r16_16_noflags) {
        genArithER_noflags(data, "-", "16", getEaa16(op), "w", r16(op->r1), 1,"3");
    } else if (op->func==sbbe16r16_32) {
        genArithER(data, "-", "FLAGS_SBB16", "16", getEaa32(op), "w", r16(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_SBB16;
...
void gen219(struct GenData* data, struct Op* op) {
    if (op->func==sbbr32r32) {
        genArithRR(data, "-", "FLAGS_SBB32", "32", r32(op->r1), r32(op->r2), 1, 1,"1");
        data->lazyFlags = sFLAGS_SBB32;
    } else if (op->func==sbbr32r32_noflags) {
        genArithRR_noflags(data, "-", "32", r32(op->r1), r32(op->r2), 1,"1");
    } else if (op->func==sbbe32r32_16) {
        genArithER(data, "-", "FLAGS_SBB32", "32", getEaa16(op), "d", r32(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_SBB32;
    } else if (op->func==sbbe32r32_16_noflags) {
        genArithER_noflags(data, "-", "32", getEaa16(op), "d", r32(op->r1), 1,"3");
    } else if (op->func==sbbe32r32_32) {
        genArithER(data, "-", "FLAGS_SBB32", "32", getEaa32(op), "d", r32(op->r1), 1, 1,"3");
        data->lazyFlags = sFLAGS_SBB32;
...
void gen01a(struct GenData* data, struct Op* op) {
    if (op->func==sbbr8r8) {
        ...
        genArithRE(data, "-", "FLAGS_SBB8", "8", getEaa16(op), "b", r8(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_SBB8;
    } else if (op->func==sbbr8e8_16_noflags) {
        genArithRE_noflags(data, "-", "8", getEaa16(op), "b", r8(op->r1), 1,"2");
    } else if (op->func==sbbr8e8_32) {
        genArithRE(data, "-", "FLAGS_SBB8", "8", getEaa32(op), "b", r8(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_SBB8;
...
void gen01b(struct GenData* data, struct Op* op) {
    if (op->func==sbbr16r16) {
        ...
        genArithRE(data, "-", "FLAGS_SBB16", "16", getEaa16(op), "w", r16(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_SBB16;
    } else if (op->func==sbbr16e16_16_noflags) {
        genArithRE_noflags(data, "-", "16", getEaa16(op), "w", r16(op->r1), 1,"2");
    } else if (op->func==sbbr16e16_32) {
        genArithRE(data, "-", "FLAGS_SBB16", "16", getEaa32(op), "w", r16(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_SBB16;
...
void gen21b(struct GenData* data, struct Op* op) {
    if (op->func==sbbr32r32) {
        ...
        genArithRE(data, "-", "FLAGS_SBB32", "32", getEaa16(op), "d", r32(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_SBB32;
    } else if (op->func==sbbr32e32_16_noflags) {
        genArithRE_noflags(data, "-", "32", getEaa16(op), "d", r32(op->r1), 1,"2");
    } else if (op->func==sbbr32e32_32) {
        genArithRE(data, "-", "FLAGS_SBB32", "32", getEaa32(op), "d", r32(op->r1), 1, 1,"2");
        data->lazyFlags = sFLAGS_SBB32;
...
void gen020(struct GenData* data, struct Op* op) {
    if (op->func==andr8r8) {
        genArithRR(data, "&", "FLAGS_AND8", "8", r8(op->r1), r8(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_AND8;
    } else if (op->func==andr8r8_noflags) {
        genArithRR_noflags(data, "&", "8", r8(op->r1), r8(op->r2), 0,"1");
    } else if (op->func==ande8r8_16) {
        genArithER(data, "&", "FLAGS_AND8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_AND8;
    } else if (op->func==ande8r8_16_noflags) {
        genArithER_noflags(data, "&", "8", getEaa16(op), "b", r8(op->r1), 0,"3");
    } else if (op->func==ande8r8_32) {
        genArithER(data, "&", "FLAGS_AND8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_AND8;
...
void gen021(struct GenData* data, struct Op* op) {
    if (op->func==andr16r16) {
        genArithRR(data, "&", "FLAGS_AND16", "16", r16(op->r1), r16(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_AND16;
    } else if (op->func==andr16r16_noflags) {
        genArithRR_noflags(data, "&", "16", r16(op->r1), r16(op->r2), 0,"1");
    } else if (op->func==ande16r16_16) {
        genArithER(data, "&", "FLAGS_AND16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_AND16;
    } else if (op->func==ande16r16_16_noflags) {
        genArithER_noflags(data, "&", "16", getEaa16(op), "w", r16(op->r1), 0,"3");
    } else if (op->func==ande16r16_32) {
        genArithER(data, "&", "FLAGS_AND16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_AND16;
...
void gen221(struct GenData* data, struct Op* op) {
    if (op->func==andr32r32) {
        genArithRR(data, "&", "FLAGS_AND32", "32", r32(op->r1), r32(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_AND32;
    } else if (op->func==andr32r32_noflags) {
        genArithRR_noflags(data, "&", "32", r32(op->r1), r32(op->r2), 0,"1");
    } else if (op->func==ande32r32_16) {
        genArithER(data, "&", "FLAGS_AND32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_AND32;
    } else if (op->func==ande32r32_16_noflags) {
        genArithER_noflags(data, "&", "32", getEaa16(op), "d", r32(op->r1), 0,"3");
    } else if (op->func==ande32r32_32) {
        genArithER(data, "&", "FLAGS_AND32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_AND32;
...
void gen022(struct GenData* data, struct Op* op) {
    if (op->func==andr8r8) {
        ...
        genArithRE(data, "&", "FLAGS_AND8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_AND8;
    } else if (op->func==andr8e8_16_noflags) {
        genArithRE_noflags(data, "&", "8", getEaa16(op), "b", r8(op->r1), 0,"2");
    } else if (op->func==andr8e8_32) {
        genArithRE(data, "&", "FLAGS_AND8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_AND8;
...
void gen023(struct GenData* data, struct Op* op) {
    if (op->func==andr16r16) {
        ...
        genArithRE(data, "&", "FLAGS_AND16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_AND16;
    } else if (op->func==andr16e16_16_noflags) {
        genArithRE_noflags(data, "&", "16", getEaa16(op), "w", r16(op->r1), 0,"2");
    } else if (op->func==andr16e16_32) {
        genArithRE(data, "&", "FLAGS_AND16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_AND16;
...
void gen223(struct GenData* data, struct Op* op) {
    if (op->func==andr32r32) {
        ...
        genArithRE(data, "&", "FLAGS_AND32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_AND32;
    } else if (op->func==andr32e32_16_noflags) {
        genArithRE_noflags(data, "&", "32", getEaa16(op), "d", r32(op->r1), 0,"2");
    } else if (op->func==andr32e32_32) {
        genArithRE(data, "&", "FLAGS_AND32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_AND32;
...
void gen028(struct GenData* data, struct Op* op) {
    if (op->func==subr8r8) {
        genArithRR(data, "-", "FLAGS_SUB8", "8", r8(op->r1), r8(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_SUB8;
    } else if (op->func==subr8r8_noflags) {
        genArithRR_noflags(data, "-", "8", r8(op->r1), r8(op->r2), 0,"1");
    } else if (op->func==sube8r8_16) {
        genArithER(data, "-", "FLAGS_SUB8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_SUB8;
    } else if (op->func==sube8r8_16_noflags) {
        genArithER_noflags(data, "-", "8", getEaa16(op), "b", r8(op->r1), 0,"3");
    } else if (op->func==sube8r8_32) {
        genArithER(data, "-", "FLAGS_SUB8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_SUB8;
...
void gen029(struct GenData* data, struct Op* op) {
    if (op->func==subr16r16) {
        genArithRR(data, "-", "FLAGS_SUB16", "16", r16(op->r1), r16(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_SUB16;
    } else if (op->func==subr16r16_noflags) {
        genArithRR_noflags(data, "-", "16", r16(op->r1), r16(op->r2), 0,"1");
    } else if (op->func==sube16r16_16) {
        genArithER(data, "-", "FLAGS_SUB16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_SUB16;
    } else if (op->func==sube16r16_16_noflags) {
        genArithER_noflags(data, "-", "16", getEaa16(op), "w", r16(op->r1), 0,"3");
    } else if (op->func==sube16r16_32) {
        genArithER(data, "-", "FLAGS_SUB16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_SUB16;
...
void gen229(struct GenData* data, struct Op* op) {
    if (op->func==subr32r32) {
        genArithRR(data, "-", "FLAGS_SUB32", "32", r32(op->r1), r32(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_SUB32;
    } else if (op->func==subr32r32_noflags) {
        genArithRR_noflags(data, "-", "32", r32(op->r1), r32(op->r2), 0,"1");
    } else if (op->func==sube32r32_16) {
        genArithER(data, "-", "FLAGS_SUB32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_SUB32;
    } else if (op->func==sube32r32_16_noflags) {
        genArithER_noflags(data, "-", "32", getEaa16(op), "d", r32(op->r1), 0,"3");
    } else if (op->func==sube32r32_32) {
        genArithER(data, "-", "FLAGS_SUB32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"3");
        data->lazyFlags = sFLAGS_SUB32;
...
void gen02a(struct GenData* data, struct Op* op) {
    if (op->func==subr8r8) {
        ...
        genArithRE(data, "-", "FLAGS_SUB8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_SUB8;
    } else if (op->func==subr8e8_16_noflags) {
        genArithRE_noflags(data, "-", "8", getEaa16(op), "b", r8(op->r1), 0,"2");
    } else if (op->func==subr8e8_32) {
        genArithRE(data, "-", "FLAGS_SUB8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_SUB8;
...
void gen02b(struct GenData* data, struct Op* op) {
    if (op->func==subr16r16) {
        ...
        genArithRE(data, "-", "FLAGS_SUB16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_SUB16;
    } else if (op->func==subr16e16_16_noflags) {
        genArithRE_noflags(data, "-", "16", getEaa16(op), "w", r16(op->r1), 0,"2");
    } else if (op->func==subr16e16_32) {
        genArithRE(data, "-", "FLAGS_SUB16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_SUB16;
...
void gen22b(struct GenData* data, struct Op* op) {
    if (op->func==subr32r32) {
        ...
        genArithRE(data, "-", "FLAGS_SUB32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_SUB32;
    } else if (op->func==subr32e32_16_noflags) {
        genArithRE_noflags(data, "-", "32", getEaa16(op), "d", r32(op->r1), 0,"2");
    } else if (op->func==subr32e32_32) {
        genArithRE(data, "-", "FLAGS_SUB32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_SUB32;
...
void gen030(struct GenData* data, struct Op* op) {
    if (op->func==xorr8r8) {
        genArithRR(data, "^", "FLAGS_XOR8", "8", r8(op->r1), r8(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_XOR8;
    } else if (op->func==xorr8r8_noflags) {
        genArithRR_noflags(data, "^", "8", r8(op->r1), r8(op->r2), 0,"1");
    } else if (op->func==xore8r8_16) {
        genArithER(data, "^", "FLAGS_XOR8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR8;
    } else if (op->func==xore8r8_16_noflags) {
        genArithER_noflags(data, "^", "8", getEaa16(op), "b", r8(op->r1), 0,"2");
    } else if (op->func==xore8r8_32) {
        genArithER(data, "^", "FLAGS_XOR8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR8;
    } else if (op->func==xore8r8_32_noflags) {
        genArithER_noflags(data, "^", "8", getEaa32(op), "b", r8(op->r1), 0,"2");
    }
}
...
void gen031(struct GenData* data, struct Op* op) {
    if (op->func==xorr16r16) {
        genArithRR(data, "^", "FLAGS_XOR16", "16", r16(op->r1), r16(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_XOR16;
    } else if (op->func==xorr16r16_noflags) {
        genArithRR_noflags(data, "^", "16", r16(op->r1), r16(op->r2), 0,"1");
    } else if (op->func==xore16r16_16) {
        genArithER(data, "^", "FLAGS_XOR16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR16;
    } else if (op->func==xore16r16_16_noflags) {
        genArithER_noflags(data, "^", "16", getEaa16(op), "w", r16(op->r1), 0,"2");
    } else if (op->func==xore16r16_32) {
        genArithER(data, "^", "FLAGS_XOR16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR16;
    } else if (op->func==xore16r16_32_noflags) {
        genArithER_noflags(data, "^", "16", getEaa32(op), "w", r16(op->r1), 0,"2");
    }
}
...
void gen231(struct GenData* data, struct Op* op) {
    if (op->func==xorr32r32) {
        genArithRR(data, "^", "FLAGS_XOR32", "32", r32(op->r1), r32(op->r2), 1, 0,"1");
        data->lazyFlags = sFLAGS_XOR32;
    } else if (op->func==xorr32r32_noflags) {
        genArithRR_noflags(data, "^", "32", r32(op->r1), r32(op->r2), 0,"1");
    } else if (op->func==xore32r32_16) {
        genArithER(data, "^", "FLAGS_XOR32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR32;
    } else if (op->func==xore32r32_16_noflags) {
        genArithER_noflags(data, "^", "32", getEaa16(op), "d", r32(op->r1), 0,"2");
    } else if (op->func==xore32r32_32) {
        genArithER(data, "^", "FLAGS_XOR32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR32;
    } else if (op->func==xore32r32_32_noflags) {
        genArithER_noflags(data, "^", "32", getEaa32(op), "d", r32(op->r1), 0,"2");
    }
}
void OPCALL xorr8r8(struct CPU* cpu, struct Op* op);
void OPCALL xorr8r8_noflags(struct CPU* cpu, struct Op* op);
...
void gen032(struct GenData* data, struct Op* op) {
    if (op->func==xorr8r8) {
        ...
        genArithRE(data, "^", "FLAGS_XOR8", "8", getEaa16(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR8;
    } else if (op->func==xorr8e8_16_noflags) {
        genArithRE_noflags(data, "^", "8", getEaa16(op), "b", r8(op->r1), 0,"2");
    } else if (op->func==xorr8e8_32) {
        genArithRE(data, "^", "FLAGS_XOR8", "8", getEaa32(op), "b", r8(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR8;
...
void gen033(struct GenData* data, struct Op* op) {
    if (op->func==xorr16r16) {
        ...
        genArithRE(data, "^", "FLAGS_XOR16", "16", getEaa16(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR16;
    } else if (op->func==xorr16e16_16_noflags) {
        genArithRE_noflags(data, "^", "16", getEaa16(op), "w", r16(op->r1), 0,"2");
    } else if (op->func==xorr16e16_32) {
        genArithRE(data, "^", "FLAGS_XOR16", "16", getEaa32(op), "w", r16(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR16;
...
void gen233(struct GenData* data, struct Op* op) {
    if (op->func==xorr32r32) {
        ...
        genArithRE(data, "^", "FLAGS_XOR32", "32", getEaa16(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR32;
    } else if (op->func==xorr32e32_16_noflags) {
        genArithRE_noflags(data, "^", "32", getEaa16(op), "d", r32(op->r1), 0,"2");
    } else if (op->func==xorr32e32_32) {
        genArithRE(data, "^", "FLAGS_XOR32", "32", getEaa32(op), "d", r32(op->r1), 1, 0,"2");
        data->lazyFlags = sFLAGS_XOR32;
...
void gen038(struct GenData* data, struct Op* op) {
    if (op->func==cmpr8r8) {
        genArithRR(data, "-", "FLAGS_CMP8", "8", r8(op->r1), r8(op->r2), 0, 0,"1");
        data->lazyFlags = sFLAGS_CMP8;
    } else if (op->func==cmpr8r8_noflags) {
        genArithRR_noflags(data, "-", "8", r8(op->r1), r8(op->r2), 0,"1");
    } else if (op->func==cmpe8r8_16) {
        genArithER(data, "-", "FLAGS_CMP8", "8", getEaa16(op), "b", r8(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP8;
    } else if (op->func==cmpe8r8_16_noflags) {
        genArithER_noflags(data, "-", "8", getEaa16(op), "b", r8(op->r1), 0,"2");
    } else if (op->func==cmpe8r8_32) {
        genArithER(data, "-", "FLAGS_CMP8", "8", getEaa32(op), "b", r8(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP8;
...
void gen039(struct GenData* data, struct Op* op) {
    if (op->func==cmpr16r16) {
        genArithRR(data, "-", "FLAGS_CMP16", "16", r16(op->r1), r16(op->r2), 0, 0,"1");
        data->lazyFlags = sFLAGS_CMP16;
    } else if (op->func==cmpr16r16_noflags) {
        genArithRR_noflags(data, "-", "16", r16(op->r1), r16(op->r2), 0,"1");
    } else if (op->func==cmpe16r16_16) {
        genArithER(data, "-", "FLAGS_CMP16", "16", getEaa16(op), "w", r16(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP16;
    } else if (op->func==cmpe16r16_16_noflags) {
        genArithER_noflags(data, "-", "16", getEaa16(op), "w", r16(op->r1), 0,"2");
    } else if (op->func==cmpe16r16_32) {
        genArithER(data, "-", "FLAGS_CMP16", "16", getEaa32(op), "w", r16(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP16;
...
void gen239(struct GenData* data, struct Op* op) {
    if (op->func==cmpr32r32) {
        genArithRR(data, "-", "FLAGS_CMP32", "32", r32(op->r1), r32(op->r2), 0, 0,"1");
        data->lazyFlags = sFLAGS_CMP32;
    } else if (op->func==cmpr32r32_noflags) {
        genArithRR_noflags(data, "-", "32", r32(op->r1), r32(op->r2), 0,"1");
    } else if (op->func==cmpe32r32_16) {
        genArithER(data, "-", "FLAGS_CMP32", "32", getEaa16(op), "d", r32(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP32;
    } else if (op->func==cmpe32r32_16_noflags) {
        genArithER_noflags(data, "-", "32", getEaa16(op), "d", r32(op->r1), 0,"2");
    } else if (op->func==cmpe32r32_32) {
        genArithER(data, "-", "FLAGS_CMP32", "32", getEaa32(op), "d", r32(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP32;
...
void gen03a(struct GenData* data, struct Op* op) {
    if (op->func==cmpr8r8) {
        ...
        genArithRE(data, "-", "FLAGS_CMP8", "8", getEaa16(op), "b", r8(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP8;
    } else if (op->func==cmpr8e8_16_noflags) {
        genArithRE_noflags(data, "-", "8", getEaa16(op), "b", r8(op->r1), 0,"2");
    } else if (op->func==cmpr8e8_32) {
        genArithRE(data, "-", "FLAGS_CMP8", "8", getEaa32(op), "b", r8(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP8;
...
void gen03b(struct GenData* data, struct Op* op) {
    if (op->func==cmpr16r16) {
        ...
        genArithRE(data, "-", "FLAGS_CMP16", "16", getEaa16(op), "w", r16(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP16;
    } else if (op->func==cmpr16e16_16_noflags) {
        genArithRE_noflags(data, "-", "16", getEaa16(op), "w", r16(op->r1), 0,"2");
    } else if (op->func==cmpr16e16_32) {
        genArithRE(data, "-", "FLAGS_CMP16", "16", getEaa32(op), "w", r16(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP16;
...
void gen23b(struct GenData* data, struct Op* op) {
    if (op->func==cmpr32r32) {
        ...
        genArithRE(data, "-", "FLAGS_CMP32", "32", getEaa16(op), "d", r32(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP32;
    } else if (op->func==cmpr32e32_16_noflags) {
        genArithRE_noflags(data, "-", "32", getEaa16(op), "d", r32(op->r1), 0,"2");
    } else if (op->func==cmpr32e32_32) {
        genArithRE(data, "-", "FLAGS_CMP32", "32", getEaa32(op), "d", r32(op->r1), 0, 0,"2");
        data->lazyFlags = sFLAGS_CMP32;
