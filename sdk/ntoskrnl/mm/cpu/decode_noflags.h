...
void OPCALL addr8r8_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] + *cpu->reg8[op->r2];
    CYCLES(1);
    NEXT();
}
...
void OPCALL add8_reg_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] + op->data1;
    CYCLES(1);
    NEXT();
}
...
void OPCALL addr16r16_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 + cpu->reg[op->r2].u16;
    CYCLES(1);
    NEXT();
}
...
void OPCALL add16_reg_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 + op->data1;
    CYCLES(1);
    NEXT();
}
...
void OPCALL addr32r32_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 + cpu->reg[op->r2].u32;
    CYCLES(1);
    NEXT();
}
...
void OPCALL add32_reg_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 + op->data1;
    CYCLES(1);
    NEXT();
}
...
void OPCALL adcr8r8_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] + *cpu->reg8[op->r2] + getCF(cpu);
    CYCLES(1);
    NEXT();
}
...
void OPCALL adc8_reg_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] + op->data1 + getCF(cpu);
    CYCLES(1);
    NEXT();
}
...
void OPCALL adcr16r16_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 + cpu->reg[op->r2].u16 + getCF(cpu);
    CYCLES(1);
    NEXT();
}
...
void OPCALL adc16_reg_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 + op->data1 + getCF(cpu);
    CYCLES(1);
    NEXT();
}
...
void OPCALL adcr32r32_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 + cpu->reg[op->r2].u32 + getCF(cpu);
    CYCLES(1);
    NEXT();
}
...
void OPCALL adc32_reg_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 + op->data1 + getCF(cpu);
    CYCLES(1);
    NEXT();
}
...
void OPCALL testr8r8_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] & *cpu->reg8[op->r2];
    CYCLES(1);
    NEXT();
}
...
void OPCALL test8_reg_noflags(struct CPU* cpu, struct Op* op) {
    *cpu->reg8[op->r1] = *cpu->reg8[op->r1] & op->data1;
    CYCLES(1);
    NEXT();
}
...
void OPCALL testr16r16_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 & cpu->reg[op->r2].u16;
    CYCLES(1);
    NEXT();
}
...
void OPCALL test16_reg_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u16 = cpu->reg[op->r1].u16 & op->data1;
    CYCLES(1);
    NEXT();
}
...
void OPCALL testr32r32_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 & cpu->reg[op->r2].u32;
    CYCLES(1);
    NEXT();
}
...
void OPCALL test32_reg_noflags(struct CPU* cpu, struct Op* op) {
    cpu->reg[op->r1].u32 = cpu->reg[op->r1].u32 & op->data1;
    CYCLES(1);
    NEXT();
}
