...
// INSB
void decode06c(struct DecodeData* data) {
    if (data->ea16) {
        if (data->rep) {
            data->op->func = insb16_r_op;
        } else {
            data->op->func = insb16_op;
        }
    } else {
        if (data->rep) {
            data->op->func = insb32_r_op;
        } else {
            data->op->func = insb32_op;
        }
    }
    data->op->data1 = data->rep_zero;
    NEXT_OP(data);
...
// INSW
void decode06d(struct DecodeData* data) {
    if (data->ea16) {
        if (data->rep) {
            data->op->func = insw16_r_op;
        } else {
            data->op->func = insw16_op;
        }
    } else {
        if (data->rep) {
            data->op->func = insw32_r_op;
        } else {
            data->op->func = insw32_op;
        }
    }
    data->op->data1 = data->rep_zero;
    NEXT_OP(data);
...
// INSD
void decode26d(struct DecodeData* data) {
    if (data->ea16) {
        if (data->rep) {
            data->op->func = insd16_r_op;
        } else {
            data->op->func = insd16_op;
        }
    } else {
        if (data->rep) {
            data->op->func = insd32_r_op;
        } else {
            data->op->func = insd32_op;
        }
    }
    data->op->data1 = data->rep_zero;
    NEXT_OP(data);
...
void decode131(struct DecodeData* data) {
    data->op->func = rdtsc;
#ifndef INCLUDE_CYCLES
    data->op->data1 = data->count;
#endif
    LOG_OP("RDTSC");
    NEXT_OP(data);
}
