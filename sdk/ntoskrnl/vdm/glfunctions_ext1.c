...
void glcommon_glAccumxOES(struct CPU* cpu) {
    if (!ext_glAccumxOES)
...
void glcommon_glActiveProgramEXT(struct CPU* cpu) {
...
void glcommon_glActiveShaderProgram(struct CPU* cpu) {
...
void glcommon_glActiveStencilFaceEXT(struct CPU* cpu) {
...
void glcommon_glActiveTextureARB(struct CPU* cpu) {
...
void glcommon_glActiveVaryingNV(struct CPU* cpu) {
...
void glcommon_glAlphaFragmentOp1ATI(struct CPU* cpu) {
...
void glcommon_glAlphaFragmentOp2ATI(struct CPU* cpu) {
...
void glcommon_glAlphaFragmentOp3ATI(struct CPU* cpu) {
...
void glcommon_glAlphaFuncxOES(struct CPU* cpu) {
...
void glcommon_glApplyFramebufferAttachmentCMAAINTEL(struct CPU* cpu) {
...
void glcommon_glApplyTextureEXT(struct CPU* cpu) {
...
void glcommon_glAreProgramsResidentNV(struct CPU* cpu) {
    if (!ext_glAreProgramsResidentNV)
        kpanic("ext_glAreProgramsResidentNV is NULL");
    {
    GLboolean* p1=marshalbool(cpu, ARG3, ARG1);EAX=GL_FUNC(ext_glAreProgramsResidentNV)(ARG1, marshalui(cpu, ARG2, ARG1), p1);
    marshalBackbool(cpu, ARG3, p1, ARG1);
    GL_LOG ("glAreProgramsResidentNV GLsizei n=%d, const GLuint* programs=%.08x, GLboolean* residences=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glAreTexturesResidentEXT(struct CPU* cpu) {
    if (!ext_glAreTexturesResidentEXT)
        kpanic("ext_glAreTexturesResidentEXT is NULL");
    {
    GLboolean* p1=marshalbool(cpu, ARG3, ARG1);EAX=GL_FUNC(ext_glAreTexturesResidentEXT)(ARG1, marshalui(cpu, ARG2, ARG1), p1);
    marshalBackbool(cpu, ARG3, p1, ARG1);
    GL_LOG ("glAreTexturesResidentEXT GLsizei n=%d, const GLuint* textures=%.08x, GLboolean* residences=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glArrayElementEXT(struct CPU* cpu) {
...
void glcommon_glArrayObjectATI(struct CPU* cpu) {
...
void glcommon_glAsyncMarkerSGIX(struct CPU* cpu) {
...
void glcommon_glAttachObjectARB(struct CPU* cpu) {
...
void glcommon_glAttachShader(struct CPU* cpu) {
...
void glcommon_glBeginConditionalRender(struct CPU* cpu) {
...
void glcommon_glBeginConditionalRenderNV(struct CPU* cpu) {
...
void glcommon_glBeginConditionalRenderNVX(struct CPU* cpu) {
...
void glcommon_glBeginFragmentShaderATI(struct CPU* cpu) {
...
void glcommon_glBeginOcclusionQueryNV(struct CPU* cpu) {
...
void glcommon_glBeginPerfMonitorAMD(struct CPU* cpu) {
...
void glcommon_glBeginPerfQueryINTEL(struct CPU* cpu) {
...
void glcommon_glBeginQuery(struct CPU* cpu) {
    if (!ext_glBeginQuery)
...
void glcommon_glBeginQueryARB(struct CPU* cpu) {
...
void glcommon_glBeginQueryIndexed(struct CPU* cpu) {
...
void glcommon_glBeginTransformFeedback(struct CPU* cpu) {
...
void glcommon_glBeginTransformFeedbackEXT(struct CPU* cpu) {
...
void glcommon_glBeginTransformFeedbackNV(struct CPU* cpu) {
...
void glcommon_glBeginVertexShaderEXT(struct CPU* cpu) {
...
void glcommon_glBeginVideoCaptureNV(struct CPU* cpu) {
...
void glcommon_glBindAttribLocation(struct CPU* cpu) {
...
void glcommon_glBindAttribLocationARB(struct CPU* cpu) {
...
void glcommon_glBindBuffer(struct CPU* cpu) {
    if (!ext_glBindBuffer)
...
void glcommon_glBindBufferARB(struct CPU* cpu) {
...
void glcommon_glBindBufferBase(struct CPU* cpu) {
...
void glcommon_glBindBufferBaseEXT(struct CPU* cpu) {
...
void glcommon_glBindBufferBaseNV(struct CPU* cpu) {
...
void glcommon_glBindBufferOffsetEXT(struct CPU* cpu) {
...
void glcommon_glBindBufferOffsetNV(struct CPU* cpu) {
...
void glcommon_glBindBufferRange(struct CPU* cpu) {
...
void glcommon_glBindBufferRangeEXT(struct CPU* cpu) {
...
void glcommon_glBindBufferRangeNV(struct CPU* cpu) {
...
void glcommon_glBindBuffersBase(struct CPU* cpu) {
    if (!ext_glBindBuffersBase)
        kpanic("ext_glBindBuffersBase is NULL");
    {
    GL_FUNC(ext_glBindBuffersBase)(ARG1, ARG2, ARG3, marshalui(cpu, ARG4, ARG3));
    GL_LOG ("glBindBuffersBase GLenum target=%d, GLuint first=%d, GLsizei count=%d, const GLuint* buffers=%.08x",ARG1,ARG2,ARG3,ARG4);
    }
}
void glcommon_glBindBuffersRange(struct CPU* cpu) {
    if (!ext_glBindBuffersRange)
        kpanic("ext_glBindBuffersRange is NULL");
    {
    GL_FUNC(ext_glBindBuffersRange)(ARG1, ARG2, ARG3, marshalui(cpu, ARG4, ARG3), marshalip(cpu, ARG5, ARG3), marshalsip(cpu, ARG6, ARG3));
...
void glcommon_glBindFragDataLocation(struct CPU* cpu) {
...
void glcommon_glBindFragDataLocationEXT(struct CPU* cpu) {
...
void glcommon_glBindFragDataLocationIndexed(struct CPU* cpu) {
...
void glcommon_glBindFragmentShaderATI(struct CPU* cpu) {
...
void glcommon_glBindFramebuffer(struct CPU* cpu) {
...
void glcommon_glBindFramebufferEXT(struct CPU* cpu) {
...
void glcommon_glBindImageTexture(struct CPU* cpu) {
...
void glcommon_glBindImageTextureEXT(struct CPU* cpu) {
...
void glcommon_glBindImageTextures(struct CPU* cpu) {
    if (!ext_glBindImageTextures)
        kpanic("ext_glBindImageTextures is NULL");
    {
    GL_FUNC(ext_glBindImageTextures)(ARG1, ARG2, marshalui(cpu, ARG3, ARG2));
    GL_LOG ("glBindImageTextures GLuint first=%d, GLsizei count=%d, const GLuint* textures=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glBindLightParameterEXT(struct CPU* cpu) {
...
void glcommon_glBindMaterialParameterEXT(struct CPU* cpu) {
...
void glcommon_glBindMultiTextureEXT(struct CPU* cpu) {
...
void glcommon_glBindParameterEXT(struct CPU* cpu) {
...
void glcommon_glBindProgramARB(struct CPU* cpu) {
...
void glcommon_glBindProgramNV(struct CPU* cpu) {
...
void glcommon_glBindProgramPipeline(struct CPU* cpu) {
...
void glcommon_glBindRenderbuffer(struct CPU* cpu) {
...
void glcommon_glBindRenderbufferEXT(struct CPU* cpu) {
...
void glcommon_glBindSampler(struct CPU* cpu) {
...
void glcommon_glBindSamplers(struct CPU* cpu) {
    if (!ext_glBindSamplers)
        kpanic("ext_glBindSamplers is NULL");
    {
    GL_FUNC(ext_glBindSamplers)(ARG1, ARG2, marshalui(cpu, ARG3, ARG2));
    GL_LOG ("glBindSamplers GLuint first=%d, GLsizei count=%d, const GLuint* samplers=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glBindTexGenParameterEXT(struct CPU* cpu) {
...
void glcommon_glBindTextureEXT(struct CPU* cpu) {
...
void glcommon_glBindTextureUnit(struct CPU* cpu) {
...
void glcommon_glBindTextureUnitParameterEXT(struct CPU* cpu) {
...
void glcommon_glBindTextures(struct CPU* cpu) {
    if (!ext_glBindTextures)
        kpanic("ext_glBindTextures is NULL");
    {
    GL_FUNC(ext_glBindTextures)(ARG1, ARG2, marshalui(cpu, ARG3, ARG2));
    GL_LOG ("glBindTextures GLuint first=%d, GLsizei count=%d, const GLuint* textures=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glBindTransformFeedback(struct CPU* cpu) {
...
void glcommon_glBindTransformFeedbackNV(struct CPU* cpu) {
...
void glcommon_glBindVertexArray(struct CPU* cpu) {
...
void glcommon_glBindVertexArrayAPPLE(struct CPU* cpu) {
...
void glcommon_glBindVertexBuffer(struct CPU* cpu) {
...
void glcommon_glBindVertexBuffers(struct CPU* cpu) {
    if (!ext_glBindVertexBuffers)
        kpanic("ext_glBindVertexBuffers is NULL");
    {
    GL_FUNC(ext_glBindVertexBuffers)(ARG1, ARG2, marshalui(cpu, ARG3, ARG2), marshalip(cpu, ARG4, ARG2), marshal2i(cpu, ARG5, ARG2));
...
void glcommon_glBindVertexShaderEXT(struct CPU* cpu) {
...
void glcommon_glBindVideoCaptureStreamBufferNV(struct CPU* cpu) {
...
void glcommon_glBindVideoCaptureStreamTextureNV(struct CPU* cpu) {
...
void glcommon_glBinormal3bEXT(struct CPU* cpu) {
...
void glcommon_glBinormal3bvEXT(struct CPU* cpu) {
    if (!ext_glBinormal3bvEXT)
        kpanic("ext_glBinormal3bvEXT is NULL");
    {
    GL_FUNC(ext_glBinormal3bvEXT)(marshalb(cpu, ARG1, 3));
    GL_LOG ("glBinormal3bvEXT const GLbyte* v=%.08x",ARG1);
    }
}
void glcommon_glBinormal3dEXT(struct CPU* cpu) {
...
void glcommon_glBinormal3dvEXT(struct CPU* cpu) {
    if (!ext_glBinormal3dvEXT)
        kpanic("ext_glBinormal3dvEXT is NULL");
    {
    GL_FUNC(ext_glBinormal3dvEXT)(marshald(cpu, ARG1, 3));
    GL_LOG ("glBinormal3dvEXT const GLdouble* v=%.08x",ARG1);
    }
}
void glcommon_glBinormal3fEXT(struct CPU* cpu) {
...
void glcommon_glBinormal3fvEXT(struct CPU* cpu) {
    if (!ext_glBinormal3fvEXT)
        kpanic("ext_glBinormal3fvEXT is NULL");
    {
    GL_FUNC(ext_glBinormal3fvEXT)(marshalf(cpu, ARG1, 3));
    GL_LOG ("glBinormal3fvEXT const GLfloat* v=%.08x",ARG1);
    }
}
void glcommon_glBinormal3iEXT(struct CPU* cpu) {
...
void glcommon_glBinormal3ivEXT(struct CPU* cpu) {
    if (!ext_glBinormal3ivEXT)
        kpanic("ext_glBinormal3ivEXT is NULL");
    {
    GL_FUNC(ext_glBinormal3ivEXT)(marshali(cpu, ARG1, 3));
    GL_LOG ("glBinormal3ivEXT const GLint* v=%.08x",ARG1);
    }
}
void glcommon_glBinormal3sEXT(struct CPU* cpu) {
...
void glcommon_glBinormal3svEXT(struct CPU* cpu) {
    if (!ext_glBinormal3svEXT)
        kpanic("ext_glBinormal3svEXT is NULL");
    {
    GL_FUNC(ext_glBinormal3svEXT)(marshals(cpu, ARG1, 3));
    GL_LOG ("glBinormal3svEXT const GLshort* v=%.08x",ARG1);
    }
}
void glcommon_glBinormalPointerEXT(struct CPU* cpu) {
...
void glcommon_glBitmapxOES(struct CPU* cpu) {
    if (!ext_glBitmapxOES)
        kpanic("ext_glBitmapxOES is NULL");
    {
    GL_FUNC(ext_glBitmapxOES)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, marshalub(cpu, ARG7, ARG1*ARG2));
...
void glcommon_glBlendBarrierKHR(struct CPU* cpu) {
...
void glcommon_glBlendBarrierNV(struct CPU* cpu) {
...
void glcommon_glBlendColorEXT(struct CPU* cpu) {
...
void glcommon_glBlendColorxOES(struct CPU* cpu) {
...
void glcommon_glBlendEquationEXT(struct CPU* cpu) {
...
void glcommon_glBlendEquationIndexedAMD(struct CPU* cpu) {
...
void glcommon_glBlendEquationSeparate(struct CPU* cpu) {
...
void glcommon_glBlendEquationSeparateEXT(struct CPU* cpu) {
...
void glcommon_glBlendEquationSeparateIndexedAMD(struct CPU* cpu) {
...
void glcommon_glBlendEquationSeparatei(struct CPU* cpu) {
...
void glcommon_glBlendEquationSeparateiARB(struct CPU* cpu) {
...
void glcommon_glBlendEquationi(struct CPU* cpu) {
...
void glcommon_glBlendEquationiARB(struct CPU* cpu) {
...
void glcommon_glBlendFuncIndexedAMD(struct CPU* cpu) {
...
void glcommon_glBlendFuncSeparate(struct CPU* cpu) {
...
void glcommon_glBlendFuncSeparateEXT(struct CPU* cpu) {
...
void glcommon_glBlendFuncSeparateINGR(struct CPU* cpu) {
...
void glcommon_glBlendFuncSeparateIndexedAMD(struct CPU* cpu) {
...
void glcommon_glBlendFuncSeparatei(struct CPU* cpu) {
...
void glcommon_glBlendFuncSeparateiARB(struct CPU* cpu) {
...
void glcommon_glBlendFunci(struct CPU* cpu) {
    if (!ext_glBlendFunci)
...
void glcommon_glBlendFunciARB(struct CPU* cpu) {
...
void glcommon_glBlendParameteriNV(struct CPU* cpu) {
...
void glcommon_glBlitFramebuffer(struct CPU* cpu) {
...
void glcommon_glBlitFramebufferEXT(struct CPU* cpu) {
...
void glcommon_glBlitNamedFramebuffer(struct CPU* cpu) {
...
void glcommon_glBufferAddressRangeNV(struct CPU* cpu) {
...
void glcommon_glBufferParameteriAPPLE(struct CPU* cpu) {
...
void glcommon_glBufferRegionEnabled(struct CPU* cpu) {
...
void glcommon_glCallCommandListNV(struct CPU* cpu) {
...
void glcommon_glCheckFramebufferStatus(struct CPU* cpu) {
...
void glcommon_glCheckFramebufferStatusEXT(struct CPU* cpu) {
...
void glcommon_glCheckNamedFramebufferStatus(struct CPU* cpu) {
...
void glcommon_glCheckNamedFramebufferStatusEXT(struct CPU* cpu) {
...
void glcommon_glClampColor(struct CPU* cpu) {
    if (!ext_glClampColor)
...
void glcommon_glClampColorARB(struct CPU* cpu) {
...
void glcommon_glClearAccumxOES(struct CPU* cpu) {
...
void glcommon_glClearBufferData(struct CPU* cpu) {
...
void glcommon_glClearBufferSubData(struct CPU* cpu) {
...
void glcommon_glClearBufferfi(struct CPU* cpu) {
...
void glcommon_glClearColorIuiEXT(struct CPU* cpu) {
...
void glcommon_glClearColorxOES(struct CPU* cpu) {
...
void glcommon_glClearDepthdNV(struct CPU* cpu) {
...
void glcommon_glClearDepthf(struct CPU* cpu) {
...
void glcommon_glClearDepthfOES(struct CPU* cpu) {
...
void glcommon_glClearDepthxOES(struct CPU* cpu) {
...
void glcommon_glClearNamedBufferData(struct CPU* cpu) {
...
void glcommon_glClearNamedBufferDataEXT(struct CPU* cpu) {
...
void glcommon_glClearNamedBufferSubData(struct CPU* cpu) {
...
void glcommon_glClearNamedBufferSubDataEXT(struct CPU* cpu) {
...
void glcommon_glClearNamedFramebufferfi(struct CPU* cpu) {
...
void glcommon_glClearNamedFramebufferfv(struct CPU* cpu) {
    if (!ext_glClearNamedFramebufferfv)
        kpanic("ext_glClearNamedFramebufferfv is NULL");
    {
    GL_FUNC(ext_glClearNamedFramebufferfv)(ARG1, ARG2, ARG3, marshalf(cpu, ARG4, 4));
...
void glcommon_glClearNamedFramebufferiv(struct CPU* cpu) {
    if (!ext_glClearNamedFramebufferiv)
        kpanic("ext_glClearNamedFramebufferiv is NULL");
    {
    GL_FUNC(ext_glClearNamedFramebufferiv)(ARG1, ARG2, ARG3, marshali(cpu, ARG4, 4));
...
void glcommon_glClearNamedFramebufferuiv(struct CPU* cpu) {
    if (!ext_glClearNamedFramebufferuiv)
        kpanic("ext_glClearNamedFramebufferuiv is NULL");
    {
    GL_FUNC(ext_glClearNamedFramebufferuiv)(ARG1, ARG2, ARG3, marshalui(cpu, ARG4, 4));
...
void glcommon_glClearTexImage(struct CPU* cpu) {
...
void glcommon_glClearTexSubImage(struct CPU* cpu) {
...
void glcommon_glClientActiveTextureARB(struct CPU* cpu) {
...
void glcommon_glClientActiveVertexStreamATI(struct CPU* cpu) {
...
void glcommon_glClientAttribDefaultEXT(struct CPU* cpu) {
...
void glcommon_glClientWaitSync(struct CPU* cpu) {
...
void glcommon_glClipControl(struct CPU* cpu) {
...
void glcommon_glColor3fVertex3fvSUN(struct CPU* cpu) {
    if (!ext_glColor3fVertex3fvSUN)
        kpanic("ext_glColor3fVertex3fvSUN is NULL");
    {
    GL_FUNC(ext_glColor3fVertex3fvSUN)(marshalf(cpu, ARG1, 3), marshal2f(cpu, ARG2, 3));
    GL_LOG ("glColor3fVertex3fvSUN const GLfloat* c=%.08x, const GLfloat* v=%.08x",ARG1,ARG2);
    }
}
void glcommon_glColor3hNV(struct CPU* cpu) {
    if (!ext_glColor3hNV)
...
void glcommon_glColor3hvNV(struct CPU* cpu) {
    if (!ext_glColor3hvNV)
        kpanic("ext_glColor3hvNV is NULL");
    {
    GL_FUNC(ext_glColor3hvNV)(marshalus(cpu, ARG1, 3));
    GL_LOG ("glColor3hvNV const GLhalfNV* v=%.08x",ARG1);
    }
}
void glcommon_glColor3xOES(struct CPU* cpu) {
    if (!ext_glColor3xOES)
...
void glcommon_glColor3xvOES(struct CPU* cpu) {
    if (!ext_glColor3xvOES)
        kpanic("ext_glColor3xvOES is NULL");
    {
    GL_FUNC(ext_glColor3xvOES)(marshali(cpu, ARG1, 3));
    GL_LOG ("glColor3xvOES const GLfixed* components=%.08x",ARG1);
    }
}
void glcommon_glColor4fNormal3fVertex3fSUN(struct CPU* cpu) {
...
void glcommon_glColor4fNormal3fVertex3fvSUN(struct CPU* cpu) {
    if (!ext_glColor4fNormal3fVertex3fvSUN)
        kpanic("ext_glColor4fNormal3fVertex3fvSUN is NULL");
    {
    GL_FUNC(ext_glColor4fNormal3fVertex3fvSUN)(marshalf(cpu, ARG1, 4), marshal2f(cpu, ARG2, 3), marshal3f(cpu, ARG3, 3));
    GL_LOG ("glColor4fNormal3fVertex3fvSUN const GLfloat* c=%.08x, const GLfloat* n=%.08x, const GLfloat* v=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glColor4hNV(struct CPU* cpu) {
    if (!ext_glColor4hNV)
...
void glcommon_glColor4hvNV(struct CPU* cpu) {
    if (!ext_glColor4hvNV)
        kpanic("ext_glColor4hvNV is NULL");
    {
    GL_FUNC(ext_glColor4hvNV)(marshalus(cpu, ARG1, 4));
    GL_LOG ("glColor4hvNV const GLhalfNV* v=%.08x",ARG1);
    }
}
void glcommon_glColor4ubVertex2fSUN(struct CPU* cpu) {
...
void glcommon_glColor4ubVertex2fvSUN(struct CPU* cpu) {
    if (!ext_glColor4ubVertex2fvSUN)
        kpanic("ext_glColor4ubVertex2fvSUN is NULL");
    {
    GL_FUNC(ext_glColor4ubVertex2fvSUN)(marshalub(cpu, ARG1, 4), marshalf(cpu, ARG2, 2));
    GL_LOG ("glColor4ubVertex2fvSUN const GLubyte* c=%.08x, const GLfloat* v=%.08x",ARG1,ARG2);
    }
}
void glcommon_glColor4ubVertex3fSUN(struct CPU* cpu) {
...
void glcommon_glColor4ubVertex3fvSUN(struct CPU* cpu) {
    if (!ext_glColor4ubVertex3fvSUN)
        kpanic("ext_glColor4ubVertex3fvSUN is NULL");
    {
    GL_FUNC(ext_glColor4ubVertex3fvSUN)(marshalub(cpu, ARG1, 4), marshalf(cpu, ARG2, 3));
    GL_LOG ("glColor4ubVertex3fvSUN const GLubyte* c=%.08x, const GLfloat* v=%.08x",ARG1,ARG2);
    }
}
void glcommon_glColor4xOES(struct CPU* cpu) {
    if (!ext_glColor4xOES)
...
void glcommon_glColor4xvOES(struct CPU* cpu) {
    if (!ext_glColor4xvOES)
        kpanic("ext_glColor4xvOES is NULL");
    {
    GL_FUNC(ext_glColor4xvOES)(marshali(cpu, ARG1, 4));
    GL_LOG ("glColor4xvOES const GLfixed* components=%.08x",ARG1);
    }
}
void glcommon_glColorFormatNV(struct CPU* cpu) {
...
void glcommon_glColorFragmentOp1ATI(struct CPU* cpu) {
...
void glcommon_glColorFragmentOp2ATI(struct CPU* cpu) {
...
void glcommon_glColorFragmentOp3ATI(struct CPU* cpu) {
...
void glcommon_glColorMaskIndexedEXT(struct CPU* cpu) {
...
void glcommon_glColorMaski(struct CPU* cpu) {
    if (!ext_glColorMaski)
...
void glcommon_glColorP3ui(struct CPU* cpu) {
    if (!ext_glColorP3ui)
...
void glcommon_glColorP3uiv(struct CPU* cpu) {
    if (!ext_glColorP3uiv)
        kpanic("ext_glColorP3uiv is NULL");
    {
    GL_FUNC(ext_glColorP3uiv)(ARG1, marshalui(cpu, ARG2, 1));
    GL_LOG ("glColorP3uiv GLenum type=%d, const GLuint* color=%.08x",ARG1,ARG2);
    }
}
void glcommon_glColorP4ui(struct CPU* cpu) {
    if (!ext_glColorP4ui)
...
void glcommon_glColorP4uiv(struct CPU* cpu) {
    if (!ext_glColorP4uiv)
        kpanic("ext_glColorP4uiv is NULL");
    {
    GL_FUNC(ext_glColorP4uiv)(ARG1, marshalui(cpu, ARG2, 1));
    GL_LOG ("glColorP4uiv GLenum type=%d, const GLuint* color=%.08x",ARG1,ARG2);
    }
}
void glcommon_glColorPointerEXT(struct CPU* cpu) {
...
void glcommon_glColorPointerListIBM(struct CPU* cpu) {
    if (!ext_glColorPointerListIBM)
        kpanic("ext_glColorPointerListIBM is NULL");
    {
    GL_FUNC(ext_glColorPointerListIBM)(ARG1, ARG2, ARG3, (void**)marshalunhandled("glColorPointerListIBM", "pointer", cpu, ARG4), ARG5);
...
void glcommon_glColorPointervINTEL(struct CPU* cpu) {
    if (!ext_glColorPointervINTEL)
        kpanic("ext_glColorPointervINTEL is NULL");
    {
    GL_FUNC(ext_glColorPointervINTEL)(ARG1, ARG2, (void**)marshalpp(cpu, ARG3, 4, 0, ARG1*getDataSize(ARG2)));
...
void glcommon_glColorSubTable(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glColorSubTable)(ARG1, ARG2, ARG3, ARG4, ARG5, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, components_in_format(ARG4)*ARG3, ARG6));
...
void glcommon_glColorSubTableEXT(struct CPU* cpu) {
...
void glcommon_glColorTable(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glColorTable)(ARG1, ARG2, ARG3, ARG4, ARG5, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, components_in_format(ARG4)*ARG3, ARG6));
...
void glcommon_glColorTableEXT(struct CPU* cpu) {
    if (!ext_glColorTableEXT)
        kpanic("ext_glColorTableEXT is NULL");
    {
    GL_FUNC(ext_glColorTableEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, components_in_format(ARG4)*ARG3, ARG6));
...
void glcommon_glColorTableParameterfv(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glColorTableParameterfv)(ARG1, ARG2, marshalf(cpu, ARG3, 4));
    GL_LOG ("glColorTableParameterfv GLenum target=%d, GLenum pname=%d, const GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glColorTableParameterfvSGI(struct CPU* cpu) {
    if (!ext_glColorTableParameterfvSGI)
        kpanic("ext_glColorTableParameterfvSGI is NULL");
    {
    GL_FUNC(ext_glColorTableParameterfvSGI)(ARG1, ARG2, marshalf(cpu, ARG3, 4));
...
void glcommon_glColorTableParameteriv(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glColorTableParameteriv)(ARG1, ARG2, marshali(cpu, ARG3, 4));
    GL_LOG ("glColorTableParameteriv GLenum target=%d, GLenum pname=%d, const GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glColorTableParameterivSGI(struct CPU* cpu) {
    if (!ext_glColorTableParameterivSGI)
        kpanic("ext_glColorTableParameterivSGI is NULL");
    {
    GL_FUNC(ext_glColorTableParameterivSGI)(ARG1, ARG2, marshali(cpu, ARG3, 4));
    GL_LOG ("glColorTableParameterivSGI GLenum target=%d, GLenum pname=%d, const GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glColorTableSGI(struct CPU* cpu) {
    if (!ext_glColorTableSGI)
        kpanic("ext_glColorTableSGI is NULL");
    {
    GL_FUNC(ext_glColorTableSGI)(ARG1, ARG2, ARG3, ARG4, ARG5, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, components_in_format(ARG4)*ARG3, ARG6));
...
void glcommon_glCombinerInputNV(struct CPU* cpu) {
...
void glcommon_glCombinerOutputNV(struct CPU* cpu) {
...
void glcommon_glCombinerParameterfNV(struct CPU* cpu) {
...
void glcommon_glCombinerParameterfvNV(struct CPU* cpu) {
    if (!ext_glCombinerParameterfvNV)
        kpanic("ext_glCombinerParameterfvNV is NULL");
    {
    GL_FUNC(ext_glCombinerParameterfvNV)(ARG1, marshalf(cpu, ARG2, 4));
    GL_LOG ("glCombinerParameterfvNV GLenum pname=%d, const GLfloat* params=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCombinerParameteriNV(struct CPU* cpu) {
...
void glcommon_glCompileCommandListNV(struct CPU* cpu) {
...
void glcommon_glCompileShader(struct CPU* cpu) {
...
void glcommon_glCompileShaderARB(struct CPU* cpu) {
...
void glcommon_glCompileShaderIncludeARB(struct CPU* cpu) {
    if (!ext_glCompileShaderIncludeARB)
        kpanic("ext_glCompileShaderIncludeARB is NULL");
    {
    GL_FUNC(ext_glCompileShaderIncludeARB)(ARG1, ARG2, (GLchar*const*)marshalpp(cpu, ARG3, ARG2, ARG4, -1), marshali(cpu, ARG4, ARG2));
...
void glcommon_glCompressedMultiTexImage1DEXT(struct CPU* cpu) {
    if (!ext_glCompressedMultiTexImage1DEXT)
        kpanic("ext_glCompressedMultiTexImage1DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedMultiTexImage1DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG8:marshalub(cpu, ARG8, ARG7));
...
void glcommon_glCompressedMultiTexImage2DEXT(struct CPU* cpu) {
    if (!ext_glCompressedMultiTexImage2DEXT)
        kpanic("ext_glCompressedMultiTexImage2DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedMultiTexImage2DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalub(cpu, ARG9, ARG8));
...
void glcommon_glCompressedMultiTexImage3DEXT(struct CPU* cpu) {
    if (!ext_glCompressedMultiTexImage3DEXT)
        kpanic("ext_glCompressedMultiTexImage3DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedMultiTexImage3DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG10:marshalub(cpu, ARG10, ARG9));
...
void glcommon_glCompressedMultiTexSubImage1DEXT(struct CPU* cpu) {
    if (!ext_glCompressedMultiTexSubImage1DEXT)
        kpanic("ext_glCompressedMultiTexSubImage1DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedMultiTexSubImage1DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG8:marshalub(cpu, ARG8, ARG7));
...
void glcommon_glCompressedMultiTexSubImage2DEXT(struct CPU* cpu) {
    if (!ext_glCompressedMultiTexSubImage2DEXT)
        kpanic("ext_glCompressedMultiTexSubImage2DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedMultiTexSubImage2DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG10:marshalub(cpu, ARG10, ARG9));
...
void glcommon_glCompressedMultiTexSubImage3DEXT(struct CPU* cpu) {
    if (!ext_glCompressedMultiTexSubImage3DEXT)
        kpanic("ext_glCompressedMultiTexSubImage3DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedMultiTexSubImage3DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10, ARG11, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG12:marshalub(cpu, ARG12, ARG11));
...
void glcommon_glCompressedTexImage1D(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glCompressedTexImage1D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG7:marshalub(cpu, ARG7, ARG6));
...
void glcommon_glCompressedTexImage1DARB(struct CPU* cpu) {
    if (!ext_glCompressedTexImage1DARB)
        kpanic("ext_glCompressedTexImage1DARB is NULL");
    {
    GL_FUNC(ext_glCompressedTexImage1DARB)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG7:marshalub(cpu, ARG7, ARG6));
...
void glcommon_glCompressedTexImage2D(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glCompressedTexImage2D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG8:marshalub(cpu, ARG8, ARG7));
...
void glcommon_glCompressedTexImage2DARB(struct CPU* cpu) {
    if (!ext_glCompressedTexImage2DARB)
        kpanic("ext_glCompressedTexImage2DARB is NULL");
    {
    GL_FUNC(ext_glCompressedTexImage2DARB)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG8:marshalub(cpu, ARG8, ARG7));
...
void glcommon_glCompressedTexImage3D(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glCompressedTexImage3D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalub(cpu, ARG9, ARG8));
...
void glcommon_glCompressedTexImage3DARB(struct CPU* cpu) {
    if (!ext_glCompressedTexImage3DARB)
        kpanic("ext_glCompressedTexImage3DARB is NULL");
    {
    GL_FUNC(ext_glCompressedTexImage3DARB)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalub(cpu, ARG9, ARG8));
...
void glcommon_glCompressedTexSubImage1D(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glCompressedTexSubImage1D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalub(cpu, ARG9, ARG8));
...
void glcommon_glCompressedTexSubImage1DARB(struct CPU* cpu) {
    if (!ext_glCompressedTexSubImage1DARB)
        kpanic("ext_glCompressedTexSubImage1DARB is NULL");
    {
    GL_FUNC(ext_glCompressedTexSubImage1DARB)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG7:marshalub(cpu, ARG7, ARG6));
...
void glcommon_glCompressedTexSubImage2D(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glCompressedTexSubImage2D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalub(cpu, ARG9, ARG8));
...
void glcommon_glCompressedTexSubImage2DARB(struct CPU* cpu) {
    if (!ext_glCompressedTexSubImage2DARB)
        kpanic("ext_glCompressedTexSubImage2DARB is NULL");
    {
    GL_FUNC(ext_glCompressedTexSubImage2DARB)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalub(cpu, ARG9, ARG8));
...
void glcommon_glCompressedTexSubImage3D(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glCompressedTexSubImage3D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG11:marshalub(cpu, ARG11, ARG10));
...
void glcommon_glCompressedTexSubImage3DARB(struct CPU* cpu) {
    if (!ext_glCompressedTexSubImage3DARB)
        kpanic("ext_glCompressedTexSubImage3DARB is NULL");
    {
    GL_FUNC(ext_glCompressedTexSubImage3DARB)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG11:marshalub(cpu, ARG11, ARG10));
...
void glcommon_glCompressedTextureImage1DEXT(struct CPU* cpu) {
    if (!ext_glCompressedTextureImage1DEXT)
        kpanic("ext_glCompressedTextureImage1DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedTextureImage1DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG8:marshalub(cpu, ARG8, ARG7));
...
void glcommon_glCompressedTextureImage2DEXT(struct CPU* cpu) {
    if (!ext_glCompressedTextureImage2DEXT)
        kpanic("ext_glCompressedTextureImage2DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedTextureImage2DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalub(cpu, ARG9, ARG8));
...
void glcommon_glCompressedTextureImage3DEXT(struct CPU* cpu) {
    if (!ext_glCompressedTextureImage3DEXT)
        kpanic("ext_glCompressedTextureImage3DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedTextureImage3DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG10:marshalub(cpu, ARG10, ARG9));
...
void glcommon_glCompressedTextureSubImage1D(struct CPU* cpu) {
    if (!ext_glCompressedTextureSubImage1D)
        kpanic("ext_glCompressedTextureSubImage1D is NULL");
    {
    GL_FUNC(ext_glCompressedTextureSubImage1D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG6:marshalub(cpu, ARG7, ARG6));
...
void glcommon_glCompressedTextureSubImage1DEXT(struct CPU* cpu) {
    if (!ext_glCompressedTextureSubImage1DEXT)
        kpanic("ext_glCompressedTextureSubImage1DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedTextureSubImage1DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG8:marshalub(cpu, ARG8, ARG7));
...
void glcommon_glCompressedTextureSubImage2D(struct CPU* cpu) {
    if (!ext_glCompressedTextureSubImage2D)
        kpanic("ext_glCompressedTextureSubImage2D is NULL");
    {
    GL_FUNC(ext_glCompressedTextureSubImage2D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalub(cpu, ARG9, ARG8));
...
void glcommon_glCompressedTextureSubImage2DEXT(struct CPU* cpu) {
    if (!ext_glCompressedTextureSubImage2DEXT)
        kpanic("ext_glCompressedTextureSubImage2DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedTextureSubImage2DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG10:marshalub(cpu, ARG10, ARG9));
...
void glcommon_glCompressedTextureSubImage3D(struct CPU* cpu) {
    if (!ext_glCompressedTextureSubImage3D)
        kpanic("ext_glCompressedTextureSubImage3D is NULL");
    {
    GL_FUNC(ext_glCompressedTextureSubImage3D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG11:marshalub(cpu, ARG11, ARG10));
...
void glcommon_glCompressedTextureSubImage3DEXT(struct CPU* cpu) {
    if (!ext_glCompressedTextureSubImage3DEXT)
        kpanic("ext_glCompressedTextureSubImage3DEXT is NULL");
    {
    GL_FUNC(ext_glCompressedTextureSubImage3DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10, ARG11, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG12:marshalub(cpu, ARG12, ARG11));
...
void glcommon_glConservativeRasterParameterfNV(struct CPU* cpu) {
...
void glcommon_glConvolutionFilter1D(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glConvolutionFilter1D)(ARG1, ARG2, ARG3, ARG4, ARG5, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, components_in_format(ARG4)*ARG3, ARG6));
...
void glcommon_glConvolutionFilter1DEXT(struct CPU* cpu) {
    if (!ext_glConvolutionFilter1DEXT)
        kpanic("ext_glConvolutionFilter1DEXT is NULL");
    {
    GL_FUNC(ext_glConvolutionFilter1DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, components_in_format(ARG4)*ARG3, ARG6));
...
void glcommon_glConvolutionFilter2D(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glConvolutionFilter2D)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG7:marshalType(cpu, ARG6, components_in_format(ARG5)*ARG4*ARG3, ARG7));
...
void glcommon_glConvolutionFilter2DEXT(struct CPU* cpu) {
    if (!ext_glConvolutionFilter2DEXT)
        kpanic("ext_glConvolutionFilter2DEXT is NULL");
    {
    GL_FUNC(ext_glConvolutionFilter2DEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG7:marshalType(cpu, ARG6, components_in_format(ARG5)*ARG4*ARG3, ARG7));
...
void glcommon_glConvolutionParameterfEXT(struct CPU* cpu) {
...
void glcommon_glConvolutionParameterfv(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glConvolutionParameterfv)(ARG1, ARG2, marshalf(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_MODE)?1:4));
    GL_LOG ("glConvolutionParameterfv GLenum target=%d, GLenum pname=%d, const GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glConvolutionParameterfvEXT(struct CPU* cpu) {
    if (!ext_glConvolutionParameterfvEXT)
        kpanic("ext_glConvolutionParameterfvEXT is NULL");
    {
    GL_FUNC(ext_glConvolutionParameterfvEXT)(ARG1, ARG2, marshalf(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_MODE_EXT)?1:4));
...
void glcommon_glConvolutionParameteriEXT(struct CPU* cpu) {
...
void glcommon_glConvolutionParameteriv(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glConvolutionParameteriv)(ARG1, ARG2, marshali(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_MODE)?1:4));
    GL_LOG ("glConvolutionParameteriv GLenum target=%d, GLenum pname=%d, const GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glConvolutionParameterivEXT(struct CPU* cpu) {
    if (!ext_glConvolutionParameterivEXT)
        kpanic("ext_glConvolutionParameterivEXT is NULL");
    {
    GL_FUNC(ext_glConvolutionParameterivEXT)(ARG1, ARG2, marshali(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_MODE_EXT)?1:4));
    GL_LOG ("glConvolutionParameterivEXT GLenum target=%d, GLenum pname=%d, const GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glConvolutionParameterxOES(struct CPU* cpu) {
...
void glcommon_glCopyColorSubTableEXT(struct CPU* cpu) {
...
void glcommon_glCopyColorTableSGI(struct CPU* cpu) {
...
void glcommon_glCopyConvolutionFilter1DEXT(struct CPU* cpu) {
...
void glcommon_glCopyConvolutionFilter2DEXT(struct CPU* cpu) {
...
void glcommon_glCopyImageSubData(struct CPU* cpu) {
...
void glcommon_glCopyImageSubDataNV(struct CPU* cpu) {
...
void glcommon_glCopyMultiTexImage1DEXT(struct CPU* cpu) {
...
void glcommon_glCopyMultiTexImage2DEXT(struct CPU* cpu) {
...
void glcommon_glCopyMultiTexSubImage1DEXT(struct CPU* cpu) {
...
void glcommon_glCopyMultiTexSubImage2DEXT(struct CPU* cpu) {
...
void glcommon_glCopyMultiTexSubImage3DEXT(struct CPU* cpu) {
...
void glcommon_glCopyNamedBufferSubData(struct CPU* cpu) {
...
void glcommon_glCopyPathNV(struct CPU* cpu) {
    if (!ext_glCopyPathNV)
...
void glcommon_glCopyTexImage1DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTexImage2DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTexSubImage1DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTexSubImage2DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTexSubImage3DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTextureImage1DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTextureImage2DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTextureSubImage1D(struct CPU* cpu) {
...
void glcommon_glCopyTextureSubImage1DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTextureSubImage2D(struct CPU* cpu) {
...
void glcommon_glCopyTextureSubImage2DEXT(struct CPU* cpu) {
...
void glcommon_glCopyTextureSubImage3D(struct CPU* cpu) {
...
void glcommon_glCopyTextureSubImage3DEXT(struct CPU* cpu) {
...
void glcommon_glCoverFillPathInstancedNV(struct CPU* cpu) {
    if (!ext_glCoverFillPathInstancedNV)
        kpanic("ext_glCoverFillPathInstancedNV is NULL");
    {
    GL_FUNC(ext_glCoverFillPathInstancedNV)(ARG1, ARG2, marshalType(cpu, ARG2, ARG1, ARG3), ARG4, ARG5, ARG6, marshalf(cpu, ARG7, floatPerTransformList(ARG6)*ARG1));
...
void glcommon_glCoverFillPathNV(struct CPU* cpu) {
...
void glcommon_glCoverStrokePathInstancedNV(struct CPU* cpu) {
    if (!ext_glCoverStrokePathInstancedNV)
        kpanic("ext_glCoverStrokePathInstancedNV is NULL");
    {
    GL_FUNC(ext_glCoverStrokePathInstancedNV)(ARG1, ARG2, marshalType(cpu, ARG2, ARG1, ARG3), ARG4, ARG5, ARG6, marshalf(cpu, ARG7, floatPerTransformList(ARG6)*ARG1));
...
void glcommon_glCoverStrokePathNV(struct CPU* cpu) {
...
void glcommon_glCoverageModulationNV(struct CPU* cpu) {
...
void glcommon_glCoverageModulationTableNV(struct CPU* cpu) {
    if (!ext_glCoverageModulationTableNV)
        kpanic("ext_glCoverageModulationTableNV is NULL");
    {
    GL_FUNC(ext_glCoverageModulationTableNV)(ARG1, marshalf(cpu, ARG2, ARG1));
    GL_LOG ("glCoverageModulationTableNV GLsizei n=%d, const GLfloat* v=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateBuffers(struct CPU* cpu) {
    if (!ext_glCreateBuffers)
        kpanic("ext_glCreateBuffers is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateBuffers)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateBuffers GLsizei n=%d, GLuint* buffers=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateCommandListsNV(struct CPU* cpu) {
    if (!ext_glCreateCommandListsNV)
        kpanic("ext_glCreateCommandListsNV is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateCommandListsNV)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateCommandListsNV GLsizei n=%d, GLuint* lists=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateFramebuffers(struct CPU* cpu) {
    if (!ext_glCreateFramebuffers)
        kpanic("ext_glCreateFramebuffers is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateFramebuffers)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateFramebuffers GLsizei n=%d, GLuint* framebuffers=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreatePerfQueryINTEL(struct CPU* cpu) {
    if (!ext_glCreatePerfQueryINTEL)
        kpanic("ext_glCreatePerfQueryINTEL is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, 1);GL_FUNC(ext_glCreatePerfQueryINTEL)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, 1);
    GL_LOG ("glCreatePerfQueryINTEL GLuint queryId=%d, GLuint* queryHandle=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateProgram(struct CPU* cpu) {
...
void glcommon_glCreateProgramObjectARB(struct CPU* cpu) {
...
void glcommon_glCreateProgramPipelines(struct CPU* cpu) {
    if (!ext_glCreateProgramPipelines)
        kpanic("ext_glCreateProgramPipelines is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateProgramPipelines)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateProgramPipelines GLsizei n=%d, GLuint* pipelines=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateQueries(struct CPU* cpu) {
    if (!ext_glCreateQueries)
        kpanic("ext_glCreateQueries is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG3, ARG2);GL_FUNC(ext_glCreateQueries)(ARG1, ARG2, p1);
    marshalBackui(cpu, ARG3, p1, ARG2);
    GL_LOG ("glCreateQueries GLenum target=%d, GLsizei n=%d, GLuint* ids=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glCreateRenderbuffers(struct CPU* cpu) {
    if (!ext_glCreateRenderbuffers)
        kpanic("ext_glCreateRenderbuffers is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateRenderbuffers)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateRenderbuffers GLsizei n=%d, GLuint* renderbuffers=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateSamplers(struct CPU* cpu) {
    if (!ext_glCreateSamplers)
        kpanic("ext_glCreateSamplers is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateSamplers)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateSamplers GLsizei n=%d, GLuint* samplers=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateShader(struct CPU* cpu) {
...
void glcommon_glCreateShaderObjectARB(struct CPU* cpu) {
...
void glcommon_glCreateShaderProgramEXT(struct CPU* cpu) {
...
void glcommon_glCreateShaderProgramv(struct CPU* cpu) {
    if (!ext_glCreateShaderProgramv)
        kpanic("ext_glCreateShaderProgramv is NULL");
    {
    EAX=GL_FUNC(ext_glCreateShaderProgramv)(ARG1, ARG2, (GLchar*const*)marshalpp(cpu, ARG3, ARG2, 0, -1));
    GL_LOG ("glCreateShaderProgramv GLenum type=%d, GLsizei count=%d, const GLchar*const* strings=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glCreateStatesNV(struct CPU* cpu) {
    if (!ext_glCreateStatesNV)
        kpanic("ext_glCreateStatesNV is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateStatesNV)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateStatesNV GLsizei n=%d, GLuint* states=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateSyncFromCLeventARB(struct CPU* cpu) {
...
void glcommon_glCreateTextures(struct CPU* cpu) {
    if (!ext_glCreateTextures)
        kpanic("ext_glCreateTextures is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG3, ARG2);GL_FUNC(ext_glCreateTextures)(ARG1, ARG2, p1);
    marshalBackui(cpu, ARG3, p1, ARG2);
    GL_LOG ("glCreateTextures GLenum target=%d, GLsizei n=%d, GLuint* textures=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glCreateTransformFeedbacks(struct CPU* cpu) {
    if (!ext_glCreateTransformFeedbacks)
        kpanic("ext_glCreateTransformFeedbacks is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateTransformFeedbacks)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateTransformFeedbacks GLsizei n=%d, GLuint* ids=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCreateVertexArrays(struct CPU* cpu) {
    if (!ext_glCreateVertexArrays)
        kpanic("ext_glCreateVertexArrays is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glCreateVertexArrays)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glCreateVertexArrays GLsizei n=%d, GLuint* arrays=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCullParameterdvEXT(struct CPU* cpu) {
    if (!ext_glCullParameterdvEXT)
        kpanic("ext_glCullParameterdvEXT is NULL");
    {
    GLdouble* p1=marshald(cpu, ARG2, 4);GL_FUNC(ext_glCullParameterdvEXT)(ARG1, p1);
    marshalBackd(cpu, ARG2, p1, 4);
    GL_LOG ("glCullParameterdvEXT GLenum pname=%d, GLdouble* params=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCullParameterfvEXT(struct CPU* cpu) {
    if (!ext_glCullParameterfvEXT)
        kpanic("ext_glCullParameterfvEXT is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG2, 4);GL_FUNC(ext_glCullParameterfvEXT)(ARG1, p1);
    marshalBackf(cpu, ARG2, p1, 4);
    GL_LOG ("glCullParameterfvEXT GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2);
    }
}
void glcommon_glCurrentPaletteMatrixARB(struct CPU* cpu) {
...
void glcommon_glDebugMessageControlARB(struct CPU* cpu) {
    if (!ext_glDebugMessageControlARB)
        kpanic("ext_glDebugMessageControlARB is NULL");
    {
    GL_FUNC(ext_glDebugMessageControlARB)(ARG1, ARG2, ARG3, ARG4, marshalui(cpu, ARG5, ARG4), bARG6);
...
void glcommon_glDebugMessageEnableAMD(struct CPU* cpu) {
    if (!ext_glDebugMessageEnableAMD)
        kpanic("ext_glDebugMessageEnableAMD is NULL");
    {
    GL_FUNC(ext_glDebugMessageEnableAMD)(ARG1, ARG2, ARG3, marshalui(cpu, ARG4, ARG3), bARG5);
...
void glcommon_glDebugMessageInsert(struct CPU* cpu) {
...
void glcommon_glDebugMessageInsertAMD(struct CPU* cpu) {
...
void glcommon_glDebugMessageInsertARB(struct CPU* cpu) {
...
void glcommon_glDeformSGIX(struct CPU* cpu) {
    if (!ext_glDeformSGIX)
...
void glcommon_glDeformationMap3dSGIX(struct CPU* cpu) {
...
void glcommon_glDeformationMap3fSGIX(struct CPU* cpu) {
...
void glcommon_glDeleteAsyncMarkersSGIX(struct CPU* cpu) {
...
void glcommon_glDeleteBufferRegion(struct CPU* cpu) {
...
void glcommon_glDeleteNamesAMD(struct CPU* cpu) {
    if (!ext_glDeleteNamesAMD)
        kpanic("ext_glDeleteNamesAMD is NULL");
    {
    GL_FUNC(ext_glDeleteNamesAMD)(ARG1, ARG2, marshalui(cpu, ARG3, ARG2));
    GL_LOG ("glDeleteNamesAMD GLenum identifier=%d, GLuint num=%d, const GLuint* names=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glDeleteObjectARB(struct CPU* cpu) {
...
void glcommon_glDeleteObjectBufferATI(struct CPU* cpu) {
...
void glcommon_glDeleteOcclusionQueriesNV(struct CPU* cpu) {
    if (!ext_glDeleteOcclusionQueriesNV)
        kpanic("ext_glDeleteOcclusionQueriesNV is NULL");
    {
    GL_FUNC(ext_glDeleteOcclusionQueriesNV)(ARG1, marshalui(cpu, ARG2, ARG1));
    GL_LOG ("glDeleteOcclusionQueriesNV GLsizei n=%d, const GLuint* ids=%.08x",ARG1,ARG2);
    }
}
void glcommon_glDeletePathsNV(struct CPU* cpu) {
...
void glcommon_glDeletePerfMonitorsAMD(struct CPU* cpu) {
    if (!ext_glDeletePerfMonitorsAMD)
        kpanic("ext_glDeletePerfMonitorsAMD is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glDeletePerfMonitorsAMD)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glDeletePerfMonitorsAMD GLsizei n=%d, GLuint* monitors=%.08x",ARG1,ARG2);
    }
}
void glcommon_glDeletePerfQueryINTEL(struct CPU* cpu) {
...
void glcommon_glDeleteProgram(struct CPU* cpu) {
...
void glcommon_glDeleteStatesNV(struct CPU* cpu) {
    if (!ext_glDeleteStatesNV)
        kpanic("ext_glDeleteStatesNV is NULL");
    {
    GL_FUNC(ext_glDeleteStatesNV)(ARG1, marshalui(cpu, ARG2, ARG1));
    GL_LOG ("glDeleteStatesNV GLsizei n=%d, const GLuint* states=%.08x",ARG1,ARG2);
    }
}
void glcommon_glDeleteSync(struct CPU* cpu) {
    if (!ext_glDeleteSync)
...
void glcommon_glDepthBoundsEXT(struct CPU* cpu) {
...
void glcommon_glDepthBoundsdNV(struct CPU* cpu) {
...
void glcommon_glDepthRangeArrayv(struct CPU* cpu) {
    if (!ext_glDepthRangeArrayv)
        kpanic("ext_glDepthRangeArrayv is NULL");
    {
    GL_FUNC(ext_glDepthRangeArrayv)(ARG1, ARG2, marshald(cpu, ARG3, ARG2*2));
    GL_LOG ("glDepthRangeArrayv GLuint first=%d, GLsizei count=%d, const GLdouble* v=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glDepthRangeIndexed(struct CPU* cpu) {
...
void glcommon_glDepthRangedNV(struct CPU* cpu) {
...
void glcommon_glDepthRangef(struct CPU* cpu) {
...
void glcommon_glDepthRangefOES(struct CPU* cpu) {
...
void glcommon_glDepthRangexOES(struct CPU* cpu) {
...
void glcommon_glDetachObjectARB(struct CPU* cpu) {
...
void glcommon_glDetachShader(struct CPU* cpu) {
...
void glcommon_glDetailTexFuncSGIS(struct CPU* cpu) {
    if (!ext_glDetailTexFuncSGIS)
        kpanic("ext_glDetailTexFuncSGIS is NULL");
    {
    GL_FUNC(ext_glDetailTexFuncSGIS)(ARG1, ARG2, marshalf(cpu, ARG3, ARG2*2));
    GL_LOG ("glDetailTexFuncSGIS GLenum target=%d, GLsizei n=%d, const GLfloat* points=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glDisableClientStateIndexedEXT(struct CPU* cpu) {
...
void glcommon_glDisableClientStateiEXT(struct CPU* cpu) {
...
void glcommon_glDisableIndexedEXT(struct CPU* cpu) {
...
void glcommon_glDisableVariantClientStateEXT(struct CPU* cpu) {
...
void glcommon_glDisableVertexArrayAttrib(struct CPU* cpu) {
...
void glcommon_glDisableVertexArrayAttribEXT(struct CPU* cpu) {
...
void glcommon_glDisableVertexArrayEXT(struct CPU* cpu) {
...
void glcommon_glDisableVertexAttribAPPLE(struct CPU* cpu) {
...
void glcommon_glDisableVertexAttribArray(struct CPU* cpu) {
...
void glcommon_glDisableVertexAttribArrayARB(struct CPU* cpu) {
...
void glcommon_glDisablei(struct CPU* cpu) {
    if (!ext_glDisablei)
...
void glcommon_glDispatchCompute(struct CPU* cpu) {
...
void glcommon_glDispatchComputeGroupSizeARB(struct CPU* cpu) {
...
void glcommon_glDispatchComputeIndirect(struct CPU* cpu) {
...
void glcommon_glDrawArraysEXT(struct CPU* cpu) {
...
void glcommon_glDrawArraysIndirect(struct CPU* cpu) {
    if (!ext_glDrawArraysIndirect)
        kpanic("ext_glDrawArraysIndirect is NULL");
    {
    GL_FUNC(ext_glDrawArraysIndirect)(ARG1, marshalui(cpu, ARG2, 4));
    GL_LOG ("glDrawArraysIndirect GLenum mode=%d, const void* indirect=%.08x",ARG1,ARG2);
    }
}
void glcommon_glDrawArraysInstanced(struct CPU* cpu) {
...
void glcommon_glDrawArraysInstancedARB(struct CPU* cpu) {
...
void glcommon_glDrawArraysInstancedBaseInstance(struct CPU* cpu) {
...
void glcommon_glDrawArraysInstancedEXT(struct CPU* cpu) {
...
void glcommon_glDrawBufferRegion(struct CPU* cpu) {
...
void glcommon_glDrawBuffers(struct CPU* cpu) {
    if (!ext_glDrawBuffers)
        kpanic("ext_glDrawBuffers is NULL");
    {
    GL_FUNC(ext_glDrawBuffers)(ARG1, marshalui(cpu, ARG2, ARG1));
    GL_LOG ("glDrawBuffers GLsizei n=%d, const GLenum* bufs=%.08x",ARG1,ARG2);
    }
}
void glcommon_glDrawBuffersARB(struct CPU* cpu) {
    if (!ext_glDrawBuffersARB)
        kpanic("ext_glDrawBuffersARB is NULL");
    {
    GL_FUNC(ext_glDrawBuffersARB)(ARG1, marshalui(cpu, ARG2, ARG1));
    GL_LOG ("glDrawBuffersARB GLsizei n=%d, const GLenum* bufs=%.08x",ARG1,ARG2);
    }
}
void glcommon_glDrawBuffersATI(struct CPU* cpu) {
    if (!ext_glDrawBuffersATI)
        kpanic("ext_glDrawBuffersATI is NULL");
    {
    GL_FUNC(ext_glDrawBuffersATI)(ARG1, marshalui(cpu, ARG2, ARG1));
    GL_LOG ("glDrawBuffersATI GLsizei n=%d, const GLenum* bufs=%.08x",ARG1,ARG2);
    }
}
void glcommon_glDrawCommandsAddressNV(struct CPU* cpu) {
    if (!ext_glDrawCommandsAddressNV)
        kpanic("ext_glDrawCommandsAddressNV is NULL");
    {
    GL_FUNC(ext_glDrawCommandsAddressNV)(ARG1, marshalui64(cpu, ARG2, ARG4), marshali(cpu, ARG3, ARG4), ARG4);
...
void glcommon_glDrawCommandsNV(struct CPU* cpu) {
    if (!ext_glDrawCommandsNV)
        kpanic("ext_glDrawCommandsNV is NULL");
    {
    GL_FUNC(ext_glDrawCommandsNV)(ARG1, ARG2, marshalip(cpu, ARG3, ARG5), marshali(cpu, ARG4, ARG5), ARG5);
...
void glcommon_glDrawCommandsStatesAddressNV(struct CPU* cpu) {
    if (!ext_glDrawCommandsStatesAddressNV)
        kpanic("ext_glDrawCommandsStatesAddressNV is NULL");
    {
    GL_FUNC(ext_glDrawCommandsStatesAddressNV)(marshalui64(cpu, ARG1, ARG5), marshali(cpu, ARG2, ARG5), marshal2ui(cpu, ARG3, ARG5), marshal3ui(cpu, ARG4, ARG5), ARG5);
...
void glcommon_glDrawCommandsStatesNV(struct CPU* cpu) {
    if (!ext_glDrawCommandsStatesNV)
        kpanic("ext_glDrawCommandsStatesNV is NULL");
    {
    GL_FUNC(ext_glDrawCommandsStatesNV)(ARG1, marshalip(cpu, ARG2, ARG6), marshali(cpu, ARG3, ARG6), marshal2ui(cpu, ARG4, ARG6), marshal3ui(cpu, ARG5, ARG6), ARG6);
...
void glcommon_glDrawElementArrayAPPLE(struct CPU* cpu) {
...
void glcommon_glDrawElementArrayATI(struct CPU* cpu) {
...
void glcommon_glDrawElementsBaseVertex(struct CPU* cpu) {
    if (!ext_glDrawElementsBaseVertex)
        kpanic("ext_glDrawElementsBaseVertex is NULL");
    {
    GL_FUNC(ext_glDrawElementsBaseVertex)(ARG1, ARG2, ARG3, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG4:marshalType(cpu, ARG3, ARG2, ARG4), ARG5);
...
void glcommon_glDrawElementsIndirect(struct CPU* cpu) {
    if (!ext_glDrawElementsIndirect)
        kpanic("ext_glDrawElementsIndirect is NULL");
    {
    GL_FUNC(ext_glDrawElementsIndirect)(ARG1, ARG2, marshalui(cpu, ARG3, 5));
    GL_LOG ("glDrawElementsIndirect GLenum mode=%d, GLenum type=%d, const void* indirect=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glDrawElementsInstanced(struct CPU* cpu) {
    if (!ext_glDrawElementsInstanced)
        kpanic("ext_glDrawElementsInstanced is NULL");
    {
    GL_FUNC(ext_glDrawElementsInstanced)(ARG1, ARG2, ARG3, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG4:marshalType(cpu, ARG3, ARG2, ARG4), ARG5);
...
void glcommon_glDrawElementsInstancedARB(struct CPU* cpu) {
    if (!ext_glDrawElementsInstancedARB)
        kpanic("ext_glDrawElementsInstancedARB is NULL");
    {
    GL_FUNC(ext_glDrawElementsInstancedARB)(ARG1, ARG2, ARG3, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG4:marshalType(cpu, ARG3, ARG2, ARG4), ARG5);
...
void glcommon_glDrawElementsInstancedBaseInstance(struct CPU* cpu) {
    if (!ext_glDrawElementsInstancedBaseInstance)
        kpanic("ext_glDrawElementsInstancedBaseInstance is NULL");
    {
    GL_FUNC(ext_glDrawElementsInstancedBaseInstance)(ARG1, ARG2, ARG3, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG4:marshalType(cpu, ARG3, ARG2, ARG4), ARG5, ARG6);
...
void glcommon_glDrawElementsInstancedBaseVertex(struct CPU* cpu) {
    if (!ext_glDrawElementsInstancedBaseVertex)
        kpanic("ext_glDrawElementsInstancedBaseVertex is NULL");
    {
    GL_FUNC(ext_glDrawElementsInstancedBaseVertex)(ARG1, ARG2, ARG3, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG4:marshalType(cpu, ARG3, ARG2, ARG4), ARG5, ARG6);
...
void glcommon_glDrawElementsInstancedBaseVertexBaseInstance(struct CPU* cpu) {
    if (!ext_glDrawElementsInstancedBaseVertexBaseInstance)
        kpanic("ext_glDrawElementsInstancedBaseVertexBaseInstance is NULL");
    {
    GL_FUNC(ext_glDrawElementsInstancedBaseVertexBaseInstance)(ARG1, ARG2, ARG3, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG4:marshalType(cpu, ARG3, ARG2, ARG4), ARG5, ARG6, ARG7);
...
void glcommon_glDrawElementsInstancedEXT(struct CPU* cpu) {
    if (!ext_glDrawElementsInstancedEXT)
        kpanic("ext_glDrawElementsInstancedEXT is NULL");
    {
    GL_FUNC(ext_glDrawElementsInstancedEXT)(ARG1, ARG2, ARG3, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG4:marshalType(cpu, ARG3, ARG2, ARG4), ARG5);
...
void glcommon_glDrawMeshArraysSUN(struct CPU* cpu) {
...
void glcommon_glDrawRangeElementArrayAPPLE(struct CPU* cpu) {
...
void glcommon_glDrawRangeElementArrayATI(struct CPU* cpu) {
...
void glcommon_glDrawRangeElements(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glDrawRangeElements)(ARG1, ARG2, ARG3, ARG4, ARG5, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, ARG4, ARG6));
...
void glcommon_glDrawRangeElementsBaseVertex(struct CPU* cpu) {
    if (!ext_glDrawRangeElementsBaseVertex)
        kpanic("ext_glDrawRangeElementsBaseVertex is NULL");
    {
    GL_FUNC(ext_glDrawRangeElementsBaseVertex)(ARG1, ARG2, ARG3, ARG4, ARG5, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, ARG4, ARG6), ARG7);
...
void glcommon_glDrawRangeElementsEXT(struct CPU* cpu) {
    if (!ext_glDrawRangeElementsEXT)
        kpanic("ext_glDrawRangeElementsEXT is NULL");
    {
    GL_FUNC(ext_glDrawRangeElementsEXT)(ARG1, ARG2, ARG3, ARG4, ARG5, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG6:marshalType(cpu, ARG5, ARG4, ARG6));
...
void glcommon_glDrawTextureNV(struct CPU* cpu) {
...
void glcommon_glDrawTransformFeedback(struct CPU* cpu) {
...
void glcommon_glDrawTransformFeedbackInstanced(struct CPU* cpu) {
...
void glcommon_glDrawTransformFeedbackNV(struct CPU* cpu) {
...
void glcommon_glDrawTransformFeedbackStream(struct CPU* cpu) {
...
void glcommon_glDrawTransformFeedbackStreamInstanced(struct CPU* cpu) {
...
void glcommon_glEdgeFlagFormatNV(struct CPU* cpu) {
...
void glcommon_glEdgeFlagPointerEXT(struct CPU* cpu) {
...
void glcommon_glEdgeFlagPointerListIBM(struct CPU* cpu) {
    if (!ext_glEdgeFlagPointerListIBM)
        kpanic("ext_glEdgeFlagPointerListIBM is NULL");
    {
    GL_FUNC(ext_glEdgeFlagPointerListIBM)(ARG1, (GLboolean**)marshalunhandled("glEdgeFlagPointerListIBM", "pointer", cpu, ARG2), ARG3);
    GL_LOG ("glEdgeFlagPointerListIBM GLint stride=%d, const GLboolean** pointer=%.08x, GLint ptrstride=%d",ARG1,ARG2,ARG3);
    }
}
void glcommon_glElementPointerAPPLE(struct CPU* cpu) {
...
void glcommon_glElementPointerATI(struct CPU* cpu) {
...
void glcommon_glEnableClientStateIndexedEXT(struct CPU* cpu) {
...
void glcommon_glEnableClientStateiEXT(struct CPU* cpu) {
...
void glcommon_glEnableIndexedEXT(struct CPU* cpu) {
...
void glcommon_glEnableVariantClientStateEXT(struct CPU* cpu) {
...
void glcommon_glEnableVertexArrayAttrib(struct CPU* cpu) {
...
void glcommon_glEnableVertexArrayAttribEXT(struct CPU* cpu) {
...
void glcommon_glEnableVertexArrayEXT(struct CPU* cpu) {
...
void glcommon_glEnableVertexAttribAPPLE(struct CPU* cpu) {
...
void glcommon_glEnableVertexAttribArray(struct CPU* cpu) {
...
void glcommon_glEnableVertexAttribArrayARB(struct CPU* cpu) {
...
void glcommon_glEnablei(struct CPU* cpu) {
    if (!ext_glEnablei)
...
void glcommon_glEndConditionalRender(struct CPU* cpu) {
...
void glcommon_glEndConditionalRenderNV(struct CPU* cpu) {
...
void glcommon_glEndConditionalRenderNVX(struct CPU* cpu) {
...
void glcommon_glEndFragmentShaderATI(struct CPU* cpu) {
...
void glcommon_glEndOcclusionQueryNV(struct CPU* cpu) {
...
void glcommon_glEndPerfMonitorAMD(struct CPU* cpu) {
...
void glcommon_glEndPerfQueryINTEL(struct CPU* cpu) {
...
void glcommon_glEndQuery(struct CPU* cpu) {
    if (!ext_glEndQuery)
...
void glcommon_glEndQueryARB(struct CPU* cpu) {
...
void glcommon_glEndQueryIndexed(struct CPU* cpu) {
...
void glcommon_glEndTransformFeedback(struct CPU* cpu) {
...
void glcommon_glEndTransformFeedbackEXT(struct CPU* cpu) {
...
void glcommon_glEndTransformFeedbackNV(struct CPU* cpu) {
...
void glcommon_glEndVertexShaderEXT(struct CPU* cpu) {
...
void glcommon_glEndVideoCaptureNV(struct CPU* cpu) {
...
void glcommon_glEvalCoord1xOES(struct CPU* cpu) {
...
void glcommon_glEvalCoord1xvOES(struct CPU* cpu) {
    if (!ext_glEvalCoord1xvOES)
        kpanic("ext_glEvalCoord1xvOES is NULL");
    {
    GL_FUNC(ext_glEvalCoord1xvOES)(marshali(cpu, ARG1, 1));
    GL_LOG ("glEvalCoord1xvOES const GLfixed* coords=%.08x",ARG1);
    }
}
void glcommon_glEvalCoord2xOES(struct CPU* cpu) {
...
void glcommon_glEvalCoord2xvOES(struct CPU* cpu) {
    if (!ext_glEvalCoord2xvOES)
        kpanic("ext_glEvalCoord2xvOES is NULL");
    {
    GL_FUNC(ext_glEvalCoord2xvOES)(marshali(cpu, ARG1, 2));
    GL_LOG ("glEvalCoord2xvOES const GLfixed* coords=%.08x",ARG1);
    }
}
void glcommon_glEvalMapsNV(struct CPU* cpu) {
    if (!ext_glEvalMapsNV)
...
void glcommon_glEvaluateDepthValuesARB(struct CPU* cpu) {
...
void glcommon_glExecuteProgramNV(struct CPU* cpu) {
    if (!ext_glExecuteProgramNV)
        kpanic("ext_glExecuteProgramNV is NULL");
    {
    GL_FUNC(ext_glExecuteProgramNV)(ARG1, ARG2, marshalf(cpu, ARG3, 4));
    GL_LOG ("glExecuteProgramNV GLenum target=%d, GLuint id=%d, const GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glExtractComponentEXT(struct CPU* cpu) {
...
void glcommon_glFinalCombinerInputNV(struct CPU* cpu) {
...
void glcommon_glFinishAsyncSGIX(struct CPU* cpu) {
    if (!ext_glFinishAsyncSGIX)
        kpanic("ext_glFinishAsyncSGIX is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG1, 1);EAX=GL_FUNC(ext_glFinishAsyncSGIX)(p1);
    marshalBackui(cpu, ARG1, p1, 1);
    GL_LOG ("glFinishAsyncSGIX GLuint* markerp=%.08x",ARG1);
    }
}
void glcommon_glFinishFenceAPPLE(struct CPU* cpu) {
...
void glcommon_glFinishFenceNV(struct CPU* cpu) {
...
void glcommon_glFinishObjectAPPLE(struct CPU* cpu) {
...
void glcommon_glFinishTextureSUNX(struct CPU* cpu) {
...
void glcommon_glFlushMappedBufferRange(struct CPU* cpu) {
...
void glcommon_glFlushMappedBufferRangeAPPLE(struct CPU* cpu) {
...
void glcommon_glFlushMappedNamedBufferRange(struct CPU* cpu) {
...
void glcommon_glFlushMappedNamedBufferRangeEXT(struct CPU* cpu) {
...
void glcommon_glFlushPixelDataRangeNV(struct CPU* cpu) {
...
void glcommon_glFlushRasterSGIX(struct CPU* cpu) {
...
void glcommon_glFlushStaticDataIBM(struct CPU* cpu) {
...
void glcommon_glFlushVertexArrayRangeAPPLE(struct CPU* cpu) {
...
void glcommon_glFlushVertexArrayRangeNV(struct CPU* cpu) {
...
void glcommon_glFogCoordFormatNV(struct CPU* cpu) {
...
void glcommon_glFogCoordPointer(struct CPU* cpu) {
...
void glcommon_glFogCoordPointerEXT(struct CPU* cpu) {
...
void glcommon_glFogCoordPointerListIBM(struct CPU* cpu) {
    if (!ext_glFogCoordPointerListIBM)
        kpanic("ext_glFogCoordPointerListIBM is NULL");
    {
    GL_FUNC(ext_glFogCoordPointerListIBM)(ARG1, ARG2, (void**)marshalunhandled("glFogCoordPointerListIBM", "pointer", cpu, ARG3), ARG4);
...
void glcommon_glFogCoordd(struct CPU* cpu) {
    if (!ext_glFogCoordd)
...
void glcommon_glFogCoorddEXT(struct CPU* cpu) {
...
void glcommon_glFogCoorddv(struct CPU* cpu) {
    if (!ext_glFogCoorddv)
        kpanic("ext_glFogCoorddv is NULL");
    {
    GL_FUNC(ext_glFogCoorddv)(marshald(cpu, ARG1, 1));
    GL_LOG ("glFogCoorddv const GLdouble* coord=%.08x",ARG1);
    }
}
void glcommon_glFogCoorddvEXT(struct CPU* cpu) {
    if (!ext_glFogCoorddvEXT)
        kpanic("ext_glFogCoorddvEXT is NULL");
    {
    GL_FUNC(ext_glFogCoorddvEXT)(marshald(cpu, ARG1, 1));
    GL_LOG ("glFogCoorddvEXT const GLdouble* coord=%.08x",ARG1);
    }
}
void glcommon_glFogCoordf(struct CPU* cpu) {
    if (!ext_glFogCoordf)
...
void glcommon_glFogCoordfEXT(struct CPU* cpu) {
...
void glcommon_glFogCoordfv(struct CPU* cpu) {
    if (!ext_glFogCoordfv)
        kpanic("ext_glFogCoordfv is NULL");
    {
    GL_FUNC(ext_glFogCoordfv)(marshalf(cpu, ARG1, 1));
    GL_LOG ("glFogCoordfv const GLfloat* coord=%.08x",ARG1);
    }
}
void glcommon_glFogCoordfvEXT(struct CPU* cpu) {
    if (!ext_glFogCoordfvEXT)
        kpanic("ext_glFogCoordfvEXT is NULL");
    {
    GL_FUNC(ext_glFogCoordfvEXT)(marshalf(cpu, ARG1, 1));
    GL_LOG ("glFogCoordfvEXT const GLfloat* coord=%.08x",ARG1);
    }
}
void glcommon_glFogCoordhNV(struct CPU* cpu) {
...
void glcommon_glFogCoordhvNV(struct CPU* cpu) {
    if (!ext_glFogCoordhvNV)
        kpanic("ext_glFogCoordhvNV is NULL");
    {
    GL_FUNC(ext_glFogCoordhvNV)(marshalus(cpu, ARG1, 1));
    GL_LOG ("glFogCoordhvNV const GLhalfNV* fog=%.08x",ARG1);
    }
}
void glcommon_glFogFuncSGIS(struct CPU* cpu) {
    if (!ext_glFogFuncSGIS)
        kpanic("ext_glFogFuncSGIS is NULL");
    {
    GL_FUNC(ext_glFogFuncSGIS)(ARG1, marshalf(cpu, ARG2, ARG1*2));
    GL_LOG ("glFogFuncSGIS GLsizei n=%d, const GLfloat* points=%.08x",ARG1,ARG2);
    }
}
void glcommon_glFogxOES(struct CPU* cpu) {
    if (!ext_glFogxOES)
...
void glcommon_glFogxvOES(struct CPU* cpu) {
    if (!ext_glFogxvOES)
...
void glcommon_glFragmentColorMaterialSGIX(struct CPU* cpu) {
...
void glcommon_glFragmentCoverageColorNV(struct CPU* cpu) {
...
void glcommon_glFragmentLightModelfSGIX(struct CPU* cpu) {
...
void glcommon_glFragmentLightModelfvSGIX(struct CPU* cpu) {
    if (!ext_glFragmentLightModelfvSGIX)
        kpanic("ext_glFragmentLightModelfvSGIX is NULL");
    {
    GL_FUNC(ext_glFragmentLightModelfvSGIX)(ARG1, marshalf(cpu, ARG2, 1));
    GL_LOG ("glFragmentLightModelfvSGIX GLenum pname=%d, const GLfloat* params=%.08x",ARG1,ARG2);
    }
}
void glcommon_glFragmentLightModeliSGIX(struct CPU* cpu) {
...
void glcommon_glFragmentLightModelivSGIX(struct CPU* cpu) {
    if (!ext_glFragmentLightModelivSGIX)
        kpanic("ext_glFragmentLightModelivSGIX is NULL");
    {
    GL_FUNC(ext_glFragmentLightModelivSGIX)(ARG1, marshali(cpu, ARG2, 1));
    GL_LOG ("glFragmentLightModelivSGIX GLenum pname=%d, const GLint* params=%.08x",ARG1,ARG2);
    }
}
void glcommon_glFragmentLightfSGIX(struct CPU* cpu) {
...
void glcommon_glFragmentLightivSGIX(struct CPU* cpu) {
    if (!ext_glFragmentLightivSGIX)
        kpanic("ext_glFragmentLightivSGIX is NULL");
    {
    GL_FUNC(ext_glFragmentLightivSGIX)(ARG1, ARG2, marshali(cpu, ARG3, 1));
    GL_LOG ("glFragmentLightivSGIX GLenum light=%d, GLenum pname=%d, const GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glFragmentMaterialfSGIX(struct CPU* cpu) {
...
void glcommon_glFragmentMaterialivSGIX(struct CPU* cpu) {
    if (!ext_glFragmentMaterialivSGIX)
        kpanic("ext_glFragmentMaterialivSGIX is NULL");
    {
    GL_FUNC(ext_glFragmentMaterialivSGIX)(ARG1, ARG2, marshali(cpu, ARG3, 1));
    GL_LOG ("glFragmentMaterialivSGIX GLenum face=%d, GLenum pname=%d, const GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glFrameTerminatorGREMEDY(struct CPU* cpu) {
...
void glcommon_glFrameZoomSGIX(struct CPU* cpu) {
...
void glcommon_glFramebufferDrawBufferEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferReadBufferEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferRenderbuffer(struct CPU* cpu) {
...
void glcommon_glFramebufferRenderbufferEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferSampleLocationsfvARB(struct CPU* cpu) {
    if (!ext_glFramebufferSampleLocationsfvARB)
        kpanic("ext_glFramebufferSampleLocationsfvARB is NULL");
    {
    GL_FUNC(ext_glFramebufferSampleLocationsfvARB)(ARG1, ARG2, ARG3, marshalf(cpu, ARG4, ARG3));
...
void glcommon_glFramebufferSampleLocationsfvNV(struct CPU* cpu) {
    if (!ext_glFramebufferSampleLocationsfvNV)
        kpanic("ext_glFramebufferSampleLocationsfvNV is NULL");
    {
    GL_FUNC(ext_glFramebufferSampleLocationsfvNV)(ARG1, ARG2, ARG3, marshalf(cpu, ARG4, ARG3));
...
void glcommon_glFramebufferTexture(struct CPU* cpu) {
...
void glcommon_glFramebufferTexture1D(struct CPU* cpu) {
...
void glcommon_glFramebufferTexture1DEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferTexture2D(struct CPU* cpu) {
...
void glcommon_glFramebufferTexture2DEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferTexture3D(struct CPU* cpu) {
...
void glcommon_glFramebufferTexture3DEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferTextureARB(struct CPU* cpu) {
...
void glcommon_glFramebufferTextureEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferTextureFaceARB(struct CPU* cpu) {
...
void glcommon_glFramebufferTextureFaceEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferTextureLayer(struct CPU* cpu) {
...
void glcommon_glFramebufferTextureLayerARB(struct CPU* cpu) {
...
void glcommon_glFramebufferTextureLayerEXT(struct CPU* cpu) {
...
void glcommon_glFramebufferTextureMultiviewOVR(struct CPU* cpu) {
...
void glcommon_glFreeObjectBufferATI(struct CPU* cpu) {
...
void glcommon_glFrustumfOES(struct CPU* cpu) {
...
void glcommon_glFrustumxOES(struct CPU* cpu) {
...
void glcommon_glGenAsyncMarkersSGIX(struct CPU* cpu) {
...
void glcommon_glGenBuffers(struct CPU* cpu) {
    if (!ext_glGenBuffers)
        kpanic("ext_glGenBuffers is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenBuffers)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenBuffers GLsizei n=%d, GLuint* buffers=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenBuffersARB(struct CPU* cpu) {
    if (!ext_glGenBuffersARB)
        kpanic("ext_glGenBuffersARB is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenBuffersARB)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenBuffersARB GLsizei n=%d, GLuint* buffers=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenFencesAPPLE(struct CPU* cpu) {
    if (!ext_glGenFencesAPPLE)
        kpanic("ext_glGenFencesAPPLE is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenFencesAPPLE)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenFencesAPPLE GLsizei n=%d, GLuint* fences=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenFencesNV(struct CPU* cpu) {
    if (!ext_glGenFencesNV)
        kpanic("ext_glGenFencesNV is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenFencesNV)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenFencesNV GLsizei n=%d, GLuint* fences=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenFragmentShadersATI(struct CPU* cpu) {
...
void glcommon_glGenTexturesEXT(struct CPU* cpu) {
    if (!ext_glGenTexturesEXT)
        kpanic("ext_glGenTexturesEXT is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenTexturesEXT)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenTexturesEXT GLsizei n=%d, GLuint* textures=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenTransformFeedbacks(struct CPU* cpu) {
    if (!ext_glGenTransformFeedbacks)
        kpanic("ext_glGenTransformFeedbacks is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenTransformFeedbacks)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenTransformFeedbacks GLsizei n=%d, GLuint* ids=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenTransformFeedbacksNV(struct CPU* cpu) {
    if (!ext_glGenTransformFeedbacksNV)
        kpanic("ext_glGenTransformFeedbacksNV is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenTransformFeedbacksNV)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenTransformFeedbacksNV GLsizei n=%d, GLuint* ids=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenVertexArrays(struct CPU* cpu) {
    if (!ext_glGenVertexArrays)
        kpanic("ext_glGenVertexArrays is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenVertexArrays)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenVertexArrays GLsizei n=%d, GLuint* arrays=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenVertexArraysAPPLE(struct CPU* cpu) {
    if (!ext_glGenVertexArraysAPPLE)
        kpanic("ext_glGenVertexArraysAPPLE is NULL");
    {
    GLuint* p1=marshalui(cpu, ARG2, ARG1);GL_FUNC(ext_glGenVertexArraysAPPLE)(ARG1, p1);
    marshalBackui(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGenVertexArraysAPPLE GLsizei n=%d, GLuint* arrays=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGenVertexShadersEXT(struct CPU* cpu) {
...
void glcommon_glGenerateMipmap(struct CPU* cpu) {
...
void glcommon_glGenerateMipmapEXT(struct CPU* cpu) {
...
void glcommon_glGenerateMultiTexMipmapEXT(struct CPU* cpu) {
...
void glcommon_glGenerateTextureMipmap(struct CPU* cpu) {
...
void glcommon_glGenerateTextureMipmapEXT(struct CPU* cpu) {
...
void glcommon_glGetActiveAtomicCounterBufferiv(struct CPU* cpu) {
    if (!ext_glGetActiveAtomicCounterBufferiv)
        kpanic("ext_glGetActiveAtomicCounterBufferiv is NULL");
    {
    GLint* p1=marshali(cpu, ARG4, (ARG3==GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES?marshalGetActiveAtomicCountersCount(ARG1, ARG2):1));GL_FUNC(ext_glGetActiveAtomicCounterBufferiv)(ARG1, ARG2, ARG3, p1);
    marshalBacki(cpu, ARG4, p1, (ARG3==GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES?marshalGetActiveAtomicCountersCount(ARG1, ARG2):1));
...
void glcommon_glGetActiveAttrib(struct CPU* cpu) {
    if (!ext_glGetActiveAttrib)
        kpanic("ext_glGetActiveAttrib is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG4, 1);GLint* p2=marshal2i(cpu, ARG5, 1);GLenum* p3=marshal3ui(cpu, ARG6, 1);GLchar* p4=marshalub(cpu, ARG7, ARG3);GL_FUNC(ext_glGetActiveAttrib)(ARG1, ARG2, ARG3, p1, p2, p3, p4);
    marshalBacki(cpu, ARG4, p1, 1);marshalBacki(cpu, ARG5, p2, 1);marshalBackui(cpu, ARG6, p3, 1);marshalBackub(cpu, ARG7, p4, ARG3);
...
void glcommon_glGetActiveAttribARB(struct CPU* cpu) {
    if (!ext_glGetActiveAttribARB)
        kpanic("ext_glGetActiveAttribARB is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG4, 1);GLint* p2=marshal2i(cpu, ARG5, 1);GLenum* p3=marshal3ui(cpu, ARG6, 1);GLcharARB* p4=marshalub(cpu, ARG7, ARG3);GL_FUNC(ext_glGetActiveAttribARB)(hARG1, ARG2, ARG3, p1, p2, p3, p4);
    marshalBacki(cpu, ARG4, p1, 1);marshalBacki(cpu, ARG5, p2, 1);marshalBackui(cpu, ARG6, p3, 1);marshalBackub(cpu, ARG7, p4, ARG3);
...
void glcommon_glGetActiveSubroutineName(struct CPU* cpu) {
    if (!ext_glGetActiveSubroutineName)
        kpanic("ext_glGetActiveSubroutineName is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG5, 1);GLchar* p2=marshalub(cpu, ARG6, ARG4);GL_FUNC(ext_glGetActiveSubroutineName)(ARG1, ARG2, ARG3, ARG4, p1, p2);
    marshalBacki(cpu, ARG5, p1, 1);marshalBackub(cpu, ARG6, p2, ARG4);
...
void glcommon_glGetActiveSubroutineUniformName(struct CPU* cpu) {
    if (!ext_glGetActiveSubroutineUniformName)
        kpanic("ext_glGetActiveSubroutineUniformName is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG5, 1);GLchar* p2=marshalub(cpu, ARG6, ARG4);GL_FUNC(ext_glGetActiveSubroutineUniformName)(ARG1, ARG2, ARG3, ARG4, p1, p2);
    marshalBacki(cpu, ARG5, p1, 1);marshalBackub(cpu, ARG6, p2, ARG4);
...
void glcommon_glGetActiveSubroutineUniformiv(struct CPU* cpu) {
    if (!ext_glGetActiveSubroutineUniformiv)
        kpanic("ext_glGetActiveSubroutineUniformiv is NULL");
    {
    GLint* p1=marshali(cpu, ARG5, (ARG4==GL_COMPATIBLE_SUBROUTINES?marshalGetCompatibleSubroutinesCount(ARG1, ARG2, ARG3):1));GL_FUNC(ext_glGetActiveSubroutineUniformiv)(ARG1, ARG2, ARG3, ARG4, p1);
    marshalBacki(cpu, ARG5, p1, (ARG4==GL_COMPATIBLE_SUBROUTINES?marshalGetCompatibleSubroutinesCount(ARG1, ARG2, ARG3):1));
...
void glcommon_glGetActiveUniform(struct CPU* cpu) {
    if (!ext_glGetActiveUniform)
        kpanic("ext_glGetActiveUniform is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG4, 1);GLint* p2=marshal2i(cpu, ARG5, 1);GLenum* p3=marshal3ui(cpu, ARG6, 1);GLchar* p4=marshalub(cpu, ARG7, ARG3);GL_FUNC(ext_glGetActiveUniform)(ARG1, ARG2, ARG3, p1, p2, p3, p4);
    marshalBacki(cpu, ARG4, p1, 1);marshalBacki(cpu, ARG5, p2, 1);marshalBackui(cpu, ARG6, p3, 1);marshalBackub(cpu, ARG7, p4, ARG3);
...
void glcommon_glGetActiveUniformARB(struct CPU* cpu) {
    if (!ext_glGetActiveUniformARB)
        kpanic("ext_glGetActiveUniformARB is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG4, 1);GLint* p2=marshal2i(cpu, ARG5, 1);GLenum* p3=marshal3ui(cpu, ARG6, 1);GLcharARB* p4=marshalub(cpu, ARG7, ARG3);GL_FUNC(ext_glGetActiveUniformARB)(hARG1, ARG2, ARG3, p1, p2, p3, p4);
    marshalBacki(cpu, ARG4, p1, 1);marshalBacki(cpu, ARG5, p2, 1);marshalBackui(cpu, ARG6, p3, 1);marshalBackub(cpu, ARG7, p4, ARG3);
...
void glcommon_glGetActiveUniformBlockName(struct CPU* cpu) {
    if (!ext_glGetActiveUniformBlockName)
        kpanic("ext_glGetActiveUniformBlockName is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG4, 1);GLchar* p2=marshalub(cpu, ARG5, ARG3);GL_FUNC(ext_glGetActiveUniformBlockName)(ARG1, ARG2, ARG3, p1, p2);
    marshalBacki(cpu, ARG4, p1, 1);marshalBackub(cpu, ARG5, p2, ARG3);
...
void glcommon_glGetActiveUniformBlockiv(struct CPU* cpu) {
    if (!ext_glGetActiveUniformBlockiv)
        kpanic("ext_glGetActiveUniformBlockiv is NULL");
    {
    GLint* p1=marshali(cpu, ARG4, (ARG3==GL_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES?marshalGetUniformBlockActiveUnformsCount(ARG1, ARG2):1));GL_FUNC(ext_glGetActiveUniformBlockiv)(ARG1, ARG2, ARG3, p1);
    marshalBacki(cpu, ARG4, p1, (ARG3==GL_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES?marshalGetUniformBlockActiveUnformsCount(ARG1, ARG2):1));
...
void glcommon_glGetActiveUniformName(struct CPU* cpu) {
    if (!ext_glGetActiveUniformName)
        kpanic("ext_glGetActiveUniformName is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG4, 1);GLchar* p2=marshalub(cpu, ARG5, ARG3);GL_FUNC(ext_glGetActiveUniformName)(ARG1, ARG2, ARG3, p1, p2);
    marshalBacki(cpu, ARG4, p1, 1);marshalBackub(cpu, ARG5, p2, ARG3);
...
void glcommon_glGetActiveUniformsiv(struct CPU* cpu) {
    if (!ext_glGetActiveUniformsiv)
        kpanic("ext_glGetActiveUniformsiv is NULL");
    {
    GLint* p1=marshal2i(cpu, ARG5, ARG2);GL_FUNC(ext_glGetActiveUniformsiv)(ARG1, ARG2, marshalui(cpu, ARG3, ARG2), ARG4, p1);
    marshalBacki(cpu, ARG5, p1, ARG2);
...
void glcommon_glGetActiveVaryingNV(struct CPU* cpu) {
    if (!ext_glGetActiveVaryingNV)
        kpanic("ext_glGetActiveVaryingNV is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG4, 1);GLsizei* p2=marshal2i(cpu, ARG5, 1);GLenum* p3=marshal3ui(cpu, ARG6, 1);GLchar* p4=marshalub(cpu, ARG7, ARG3);GL_FUNC(ext_glGetActiveVaryingNV)(ARG1, ARG2, ARG3, p1, p2, p3, p4);
    marshalBacki(cpu, ARG4, p1, 1);marshalBacki(cpu, ARG5, p2, 1);marshalBackui(cpu, ARG6, p3, 1);marshalBackub(cpu, ARG7, p4, ARG3);
...
void glcommon_glGetAttachedShaders(struct CPU* cpu) {
    if (!ext_glGetAttachedShaders)
        kpanic("ext_glGetAttachedShaders is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG3, 1);GLuint* p2=marshal2ui(cpu, ARG4, ARG2);GL_FUNC(ext_glGetAttachedShaders)(ARG1, ARG2, p1, p2);
    marshalBacki(cpu, ARG3, p1, 1);marshalBackui(cpu, ARG4, p2, ARG2);
    GL_LOG ("glGetAttachedShaders GLuint program=%d, GLsizei maxCount=%d, GLsizei* count=%.08x, GLuint* shaders=%.08x",ARG1,ARG2,ARG3,ARG4);
    }
}
void glcommon_glGetAttribLocation(struct CPU* cpu) {
...
void glcommon_glGetAttribLocationARB(struct CPU* cpu) {
...
void glcommon_glGetBufferPointervARB(struct CPU* cpu) {
...
void glcommon_glGetColorTable(struct CPU* cpu) {
    ...
    {
    static GLubyte* buffer;static U32 bufferLen; GLubyte* p; GLboolean b=PIXEL_PACK_BUFFER(); U32 colors; if (b)p=(GLubyte*)ARG4; else {U32 len;colors=components_in_format(ARG2)*marshalGetColorTableWidth(ARG1);len=colors*getDataSize(ARG3);if (bufferLen<len){if (buffer) kfree(buffer,KALLOC_OPENGL);buffer=kalloc(len, KALLOC_OPENGL);bufferLen=len;} p=buffer;}GL_FUNC(ext_glGetColorTable)(ARG1, ARG2, ARG3, p);
...
void glcommon_glGetColorTableEXT(struct CPU* cpu) {
    if (!ext_glGetColorTableEXT)
        kpanic("ext_glGetColorTableEXT is NULL");
    {
    static GLubyte* p;static U32 plen;U32 colors=components_in_format(ARG2)*marshalGetColorTableWidthEXT(ARG1);U32 len=colors*getDataSize(ARG3);if (plen<len){if (p) kfree(p,KALLOC_OPENGL);p=kalloc(len, KALLOC_OPENGL);plen=len;}GL_FUNC(ext_glGetColorTableEXT)(ARG1, ARG2, ARG3, p);
    marshalBackType(cpu, ARG3, colors, p, ARG4);
...
void glcommon_glGetColorTableParameterfv(struct CPU* cpu) {
    ...
    {
    GLfloat* p1=marshalf(cpu, ARG3, 1);GL_FUNC(ext_glGetColorTableParameterfv)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, 1);
    GL_LOG ("glGetColorTableParameterfv GLenum target=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetColorTableParameterfvEXT(struct CPU* cpu) {
    if (!ext_glGetColorTableParameterfvEXT)
        kpanic("ext_glGetColorTableParameterfvEXT is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG3, 1);GL_FUNC(ext_glGetColorTableParameterfvEXT)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, 1);
    GL_LOG ("glGetColorTableParameterfvEXT GLenum target=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetColorTableParameterfvSGI(struct CPU* cpu) {
    if (!ext_glGetColorTableParameterfvSGI)
        kpanic("ext_glGetColorTableParameterfvSGI is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG3, 1);GL_FUNC(ext_glGetColorTableParameterfvSGI)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, 1);
...
void glcommon_glGetColorTableParameteriv(struct CPU* cpu) {
    ...
    {
    GLint* p1=marshali(cpu, ARG3, 1);GL_FUNC(ext_glGetColorTableParameteriv)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, 1);
    GL_LOG ("glGetColorTableParameteriv GLenum target=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetColorTableParameterivEXT(struct CPU* cpu) {
    if (!ext_glGetColorTableParameterivEXT)
        kpanic("ext_glGetColorTableParameterivEXT is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, 1);GL_FUNC(ext_glGetColorTableParameterivEXT)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, 1);
    GL_LOG ("glGetColorTableParameterivEXT GLenum target=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetColorTableParameterivSGI(struct CPU* cpu) {
    if (!ext_glGetColorTableParameterivSGI)
        kpanic("ext_glGetColorTableParameterivSGI is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, 1);GL_FUNC(ext_glGetColorTableParameterivSGI)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, 1);
    GL_LOG ("glGetColorTableParameterivSGI GLenum target=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetColorTableSGI(struct CPU* cpu) {
    if (!ext_glGetColorTableSGI)
        kpanic("ext_glGetColorTableSGI is NULL");
    {
    static GLubyte* p;static U32 plen;U32 colors=components_in_format(ARG2)*marshalGetColorTableWidthSGI(ARG1);U32 len=colors*getDataSize(ARG3);if (plen<len){if (p) kfree(p,KALLOC_OPENGL);p=kalloc(len, KALLOC_OPENGL);plen=len;}GL_FUNC(ext_glGetColorTableSGI)(ARG1, ARG2, ARG3, p);
    marshalBackType(cpu, ARG3, colors, p, ARG4);
    GL_LOG ("glGetColorTableSGI GLenum target=%d, GLenum format=%d, GLenum type=%d, void* table=%.08x",ARG1,ARG2,ARG3,ARG4);
    }
}
void glcommon_glGetCombinerInputParameterfvNV(struct CPU* cpu) {
    if (!ext_glGetCombinerInputParameterfvNV)
        kpanic("ext_glGetCombinerInputParameterfvNV is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG5, 1);GL_FUNC(ext_glGetCombinerInputParameterfvNV)(ARG1, ARG2, ARG3, ARG4, p1);
    marshalBackf(cpu, ARG5, p1, 1);
...
void glcommon_glGetCombinerInputParameterivNV(struct CPU* cpu) {
    if (!ext_glGetCombinerInputParameterivNV)
        kpanic("ext_glGetCombinerInputParameterivNV is NULL");
    {
    GLint* p1=marshali(cpu, ARG5, 1);GL_FUNC(ext_glGetCombinerInputParameterivNV)(ARG1, ARG2, ARG3, ARG4, p1);
    marshalBacki(cpu, ARG5, p1, 1);
...
void glcommon_glGetCombinerOutputParameterfvNV(struct CPU* cpu) {
    if (!ext_glGetCombinerOutputParameterfvNV)
        kpanic("ext_glGetCombinerOutputParameterfvNV is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG4, 1);GL_FUNC(ext_glGetCombinerOutputParameterfvNV)(ARG1, ARG2, ARG3, p1);
    marshalBackf(cpu, ARG4, p1, 1);
...
void glcommon_glGetCombinerOutputParameterivNV(struct CPU* cpu) {
    if (!ext_glGetCombinerOutputParameterivNV)
        kpanic("ext_glGetCombinerOutputParameterivNV is NULL");
    {
    GLint* p1=marshali(cpu, ARG4, 1);GL_FUNC(ext_glGetCombinerOutputParameterivNV)(ARG1, ARG2, ARG3, p1);
    marshalBacki(cpu, ARG4, p1, 1);
...
void glcommon_glGetCombinerStageParameterfvNV(struct CPU* cpu) {
    if (!ext_glGetCombinerStageParameterfvNV)
        kpanic("ext_glGetCombinerStageParameterfvNV is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG3, 4);GL_FUNC(ext_glGetCombinerStageParameterfvNV)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, 4);
    GL_LOG ("glGetCombinerStageParameterfvNV GLenum stage=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetCommandHeaderNV(struct CPU* cpu) {
...
void glcommon_glGetCompressedMultiTexImageEXT(struct CPU* cpu) {
    if (!ext_glGetCompressedMultiTexImageEXT)
        kpanic("ext_glGetCompressedMultiTexImageEXT is NULL");
    {
    GLboolean b=PIXEL_PACK_BUFFER(); int size = 0; GLvoid* p; if (b) p=(GLvoid*)ARG4; else {size = marshalGetCompressedMultiImageSizeEXT(ARG1, ARG2, ARG3); p = marshalui(cpu, ARG4, size);}GL_FUNC(ext_glGetCompressedMultiTexImageEXT)(ARG1, ARG2, ARG3, p);
    if (!b) marshalBackui(cpu, ARG4, p, size);
...
void glcommon_glGetCompressedTexImage(struct CPU* cpu) {
    ...
    {
    GLboolean b=PIXEL_PACK_BUFFER(); int size = 0; GLvoid* p; if (b) p=(GLvoid*)ARG3; else {size = marshalGetCompressedImageSize(ARG1, ARG2); p = marshalui(cpu, ARG3, size);}GL_FUNC(ext_glGetCompressedTexImage)(ARG1, ARG2, p);
    if (!b) marshalBackui(cpu, ARG3, p, size);
    GL_LOG ("glGetCompressedTexImage GLenum target=%d, GLint level=%d, void* img=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetCompressedTexImageARB(struct CPU* cpu) {
    if (!ext_glGetCompressedTexImageARB)
        kpanic("ext_glGetCompressedTexImageARB is NULL");
    {
    GLboolean b=PIXEL_PACK_BUFFER(); int size = 0; GLvoid* p; if (b) p=(GLvoid*)ARG3; else {size = marshalGetCompressedImageSizeARB(ARG1, ARG2); p = marshalui(cpu, ARG3, size);}GL_FUNC(ext_glGetCompressedTexImageARB)(ARG1, ARG2, p);
    if (!b) marshalBackui(cpu, ARG3, p, size);
    GL_LOG ("glGetCompressedTexImageARB GLenum target=%d, GLint level=%d, void* img=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetCompressedTextureImage(struct CPU* cpu) {
    if (!ext_glGetCompressedTextureImage)
        kpanic("ext_glGetCompressedTextureImage is NULL");
    {
    GLboolean b=PIXEL_PACK_BUFFER(); GLvoid* p; if (b) p=(GLvoid*)ARG4; else {p = marshalui(cpu, ARG4, ARG3);}GL_FUNC(ext_glGetCompressedTextureImage)(ARG1, ARG2, ARG3, p);
    if (!b) marshalBackui(cpu, ARG4, p, ARG3);
    GL_LOG ("glGetCompressedTextureImage GLuint texture=%d, GLint level=%d, GLsizei bufSize=%d, void* pixels=%.08x",ARG1,ARG2,ARG3,ARG4);
    }
}
void glcommon_glGetCompressedTextureImageEXT(struct CPU* cpu) {
    if (!ext_glGetCompressedTextureImageEXT)
        kpanic("ext_glGetCompressedTextureImageEXT is NULL");
    {
    GLboolean b=PIXEL_PACK_BUFFER(); int size = 0; GLvoid* p; if (b) p=(GLvoid*)ARG4; else {size = marshalGetCompressedTextureSizeEXT(ARG1, ARG2, ARG3); p = marshalui(cpu, ARG4, size);}GL_FUNC(ext_glGetCompressedTextureImageEXT)(ARG1, ARG2, ARG3, p);
    if (!b) marshalBackui(cpu, ARG4, p, size);
    GL_LOG ("glGetCompressedTextureImageEXT GLuint texture=%d, GLenum target=%d, GLint lod=%d, void* img=%.08x",ARG1,ARG2,ARG3,ARG4);
    }
}
void glcommon_glGetCompressedTextureSubImage(struct CPU* cpu) {
    if (!ext_glGetCompressedTextureSubImage)
        kpanic("ext_glGetCompressedTextureSubImage is NULL");
    {
    GLboolean b=PIXEL_PACK_BUFFER(); GLvoid* p; if (b) p=(GLvoid*)ARG9; else {p = marshalui(cpu, ARG9, ARG8);}GL_FUNC(ext_glGetCompressedTextureSubImage)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, p);
    if (!b) marshalBackui(cpu, ARG9, p, ARG8);
...
void glcommon_glGetConvolutionFilter(struct CPU* cpu) {
    ...
    {
    GLboolean b=PIXEL_PACK_BUFFER(); GLvoid* p; int count; if (b) p=(GLvoid*)ARG4; else {count = components_in_format(ARG2)*marshalGetConvolutionWidth(ARG1)*marshalGetConvolutionWidth(ARG2); p = marshalType(cpu, ARG3, count, ARG4);}GL_FUNC(ext_glGetConvolutionFilter)(ARG1, ARG2, ARG3, p);
...
void glcommon_glGetConvolutionFilterEXT(struct CPU* cpu) {
    if (!ext_glGetConvolutionFilterEXT)
        kpanic("ext_glGetConvolutionFilterEXT is NULL");
    {
    GLboolean b=PIXEL_PACK_BUFFER(); GLvoid* p; int count; if (b) p=(GLvoid*)ARG4; else {count = components_in_format(ARG2)*marshalGetConvolutionWidth(ARG1)*marshalGetConvolutionWidth(ARG2); p = marshalType(cpu, ARG3, count, ARG4);}GL_FUNC(ext_glGetConvolutionFilterEXT)(ARG1, ARG2, ARG3, p);
    if (!b) marshalBackType(cpu, ARG3, count, p, ARG4);
...
void glcommon_glGetConvolutionParameterfv(struct CPU* cpu) {
    ...
    {
    GLfloat* p1=marshalf(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);GL_FUNC(ext_glGetConvolutionParameterfv)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);
    GL_LOG ("glGetConvolutionParameterfv GLenum target=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetConvolutionParameterfvEXT(struct CPU* cpu) {
    if (!ext_glGetConvolutionParameterfvEXT)
        kpanic("ext_glGetConvolutionParameterfvEXT is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);GL_FUNC(ext_glGetConvolutionParameterfvEXT)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);
...
void glcommon_glGetConvolutionParameteriv(struct CPU* cpu) {
    ...
    {
    GLint* p1=marshali(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);GL_FUNC(ext_glGetConvolutionParameteriv)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);
    GL_LOG ("glGetConvolutionParameteriv GLenum target=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetConvolutionParameterivEXT(struct CPU* cpu) {
    if (!ext_glGetConvolutionParameterivEXT)
        kpanic("ext_glGetConvolutionParameterivEXT is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);GL_FUNC(ext_glGetConvolutionParameterivEXT)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);
    GL_LOG ("glGetConvolutionParameterivEXT GLenum target=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetConvolutionParameterxvOES(struct CPU* cpu) {
    if (!ext_glGetConvolutionParameterxvOES)
        kpanic("ext_glGetConvolutionParameterxvOES is NULL");
    {
    GLfixed* p1=marshali(cpu, ARG3, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);GL_FUNC(ext_glGetConvolutionParameterxvOES)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, (ARG2==GL_CONVOLUTION_BORDER_COLOR || ARG2==GL_CONVOLUTION_FILTER_SCALE || ARG2==GL_CONVOLUTION_FILTER_BIAS)?4:1);
    GL_LOG ("glGetConvolutionParameterxvOES GLenum target=%d, GLenum pname=%d, GLfixed* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetCoverageModulationTableNV(struct CPU* cpu) {
    if (!ext_glGetCoverageModulationTableNV)
        kpanic("ext_glGetCoverageModulationTableNV is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG2, ARG1);GL_FUNC(ext_glGetCoverageModulationTableNV)(ARG1, p1);
    marshalBackf(cpu, ARG2, p1, ARG1);
    GL_LOG ("glGetCoverageModulationTableNV GLsizei bufsize=%d, GLfloat* v=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGetDebugMessageLog(struct CPU* cpu) {
    if (!ext_glGetDebugMessageLog)
        kpanic("ext_glGetDebugMessageLog is NULL");
    {
    GLenum* p1=marshalui(cpu, ARG3, ARG1);GLenum* p2=marshal2ui(cpu, ARG4, ARG1);GLuint* p3=marshal3ui(cpu, ARG5, ARG1);GLenum* p4=marshal4ui(cpu, ARG6, ARG1);GLsizei* p5=marshal5i(cpu, ARG7, ARG1);GLchar* p6=marshalub(cpu, ARG8, ARG2);EAX=GL_FUNC(ext_glGetDebugMessageLog)(ARG1, ARG2, p1, p2, p3, p4, p5, p6);
    marshalBackui(cpu, ARG3, p1, ARG1);marshalBackui(cpu, ARG4, p2, ARG1);marshalBackui(cpu, ARG5, p3, ARG1);marshalBackui(cpu, ARG6, p4, ARG1);marshalBacki(cpu, ARG7, p5, ARG1);marshalBackub(cpu, ARG8, p6, ARG2);
...
void glcommon_glGetDebugMessageLogAMD(struct CPU* cpu) {
    if (!ext_glGetDebugMessageLogAMD)
        kpanic("ext_glGetDebugMessageLogAMD is NULL");
    {
    GLenum* p1=marshalui(cpu, ARG3, ARG1);GLuint* p2=marshal2ui(cpu, ARG4, ARG1);GLuint* p3=marshal3ui(cpu, ARG5, ARG1);GLsizei* p4=marshal4i(cpu, ARG6, ARG1);GLchar* p5=marshalub(cpu, ARG7, ARG2);EAX=GL_FUNC(ext_glGetDebugMessageLogAMD)(ARG1, ARG2, p1, p2, p3, p4, p5);
    marshalBackui(cpu, ARG3, p1, ARG1);marshalBackui(cpu, ARG4, p2, ARG1);marshalBackui(cpu, ARG5, p3, ARG1);marshalBacki(cpu, ARG6, p4, ARG1);marshalBackub(cpu, ARG7, p5, ARG2);
...
void glcommon_glGetDebugMessageLogARB(struct CPU* cpu) {
    if (!ext_glGetDebugMessageLogARB)
        kpanic("ext_glGetDebugMessageLogARB is NULL");
    {
    GLenum* p1=marshalui(cpu, ARG3, ARG1);GLenum* p2=marshal2ui(cpu, ARG4, ARG1);GLuint* p3=marshal3ui(cpu, ARG5, ARG1);GLenum* p4=marshal4ui(cpu, ARG6, ARG1);GLsizei* p5=marshal5i(cpu, ARG7, ARG1);GLchar* p6=marshalub(cpu, ARG8, ARG2);EAX=GL_FUNC(ext_glGetDebugMessageLogARB)(ARG1, ARG2, p1, p2, p3, p4, p5, p6);
    marshalBackui(cpu, ARG3, p1, ARG1);marshalBackui(cpu, ARG4, p2, ARG1);marshalBackui(cpu, ARG5, p3, ARG1);marshalBackui(cpu, ARG6, p4, ARG1);marshalBacki(cpu, ARG7, p5, ARG1);marshalBackub(cpu, ARG8, p6, ARG2);
...
void glcommon_glGetDetailTexFuncSGIS(struct CPU* cpu) {
...
void glcommon_glGetFragDataIndex(struct CPU* cpu) {
...
void glcommon_glGetFragDataLocation(struct CPU* cpu) {
...
void glcommon_glGetFragDataLocationEXT(struct CPU* cpu) {
...
void glcommon_glGetFragmentLightfvSGIX(struct CPU* cpu) {
    if (!ext_glGetFragmentLightfvSGIX)
        kpanic("ext_glGetFragmentLightfvSGIX is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG3, glcommon_glLightv_size(ARG2));GL_FUNC(ext_glGetFragmentLightfvSGIX)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, glcommon_glLightv_size(ARG2));
    GL_LOG ("glGetFragmentLightfvSGIX GLenum light=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetFragmentLightivSGIX(struct CPU* cpu) {
    if (!ext_glGetFragmentLightivSGIX)
        kpanic("ext_glGetFragmentLightivSGIX is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, glcommon_glLightv_size(ARG2));GL_FUNC(ext_glGetFragmentLightivSGIX)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, glcommon_glLightv_size(ARG2));
    GL_LOG ("glGetFragmentLightivSGIX GLenum light=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetFragmentMaterialfvSGIX(struct CPU* cpu) {
    if (!ext_glGetFragmentMaterialfvSGIX)
        kpanic("ext_glGetFragmentMaterialfvSGIX is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG3, glcommon_glMaterialv_size(ARG2));GL_FUNC(ext_glGetFragmentMaterialfvSGIX)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, glcommon_glMaterialv_size(ARG2));
    GL_LOG ("glGetFragmentMaterialfvSGIX GLenum face=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetFragmentMaterialivSGIX(struct CPU* cpu) {
    if (!ext_glGetFragmentMaterialivSGIX)
        kpanic("ext_glGetFragmentMaterialivSGIX is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, glcommon_glMaterialv_size(ARG2));GL_FUNC(ext_glGetFragmentMaterialivSGIX)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, glcommon_glMaterialv_size(ARG2));
    GL_LOG ("glGetFragmentMaterialivSGIX GLenum face=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetFramebufferAttachmentParameteriv(struct CPU* cpu) {
    if (!ext_glGetFramebufferAttachmentParameteriv)
        kpanic("ext_glGetFramebufferAttachmentParameteriv is NULL");
    {
    GLint* p1=marshali(cpu, ARG4, 1);GL_FUNC(ext_glGetFramebufferAttachmentParameteriv)(ARG1, ARG2, ARG3, p1);
    marshalBacki(cpu, ARG4, p1, 1);
...
void glcommon_glGetFramebufferAttachmentParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetGraphicsResetStatusARB(struct CPU* cpu) {
...
void glcommon_glGetHandleARB(struct CPU* cpu) {
...
void glcommon_glGetHistogram(struct CPU* cpu) {
    ...
    {
    GLboolean b=PIXEL_PACK_BUFFER(); int size = 0; GLvoid* p; if (b) p=(GLvoid*)ARG5; else {size = marshalHistogramWidth(ARG1); p = marshalPixels(cpu, 0, size, 1, 0, ARG3, ARG4, ARG5);}GL_FUNC(ext_glGetHistogram)(ARG1, bARG2, ARG3, ARG4, p);
...
void glcommon_glGetHistogramEXT(struct CPU* cpu) {
    if (!ext_glGetHistogramEXT)
        kpanic("ext_glGetHistogramEXT is NULL");
    {
    GLboolean b=PIXEL_PACK_BUFFER(); int size = 0; GLvoid* p; if (b) p=(GLvoid*)ARG5; else {size = marshalHistogramWidth(ARG1); p = marshalPixels(cpu, 0, size, 1, 0, ARG3, ARG4, ARG5);}GL_FUNC(ext_glGetHistogramEXT)(ARG1, bARG2, ARG3, ARG4, p);
    if (!b) marshalBackPixels(cpu, 0, size, 1, 0, ARG3, ARG4, ARG5, p);
...
void glcommon_glGetHistogramParameterfv(struct CPU* cpu) {
    ...
    {
    GLfloat* p1=marshalf(cpu, ARG3, 1);GL_FUNC(ext_glGetHistogramParameterfv)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, 1);
    GL_LOG ("glGetHistogramParameterfv GLenum target=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetHistogramParameterfvEXT(struct CPU* cpu) {
    if (!ext_glGetHistogramParameterfvEXT)
        kpanic("ext_glGetHistogramParameterfvEXT is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG3, 1);GL_FUNC(ext_glGetHistogramParameterfvEXT)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, 1);
...
void glcommon_glGetImageHandleNV(struct CPU* cpu) {
...
void glcommon_glGetImageTransformParameterfvHP(struct CPU* cpu) {
    if (!ext_glGetImageTransformParameterfvHP)
        kpanic("ext_glGetImageTransformParameterfvHP is NULL");
    {
    GLfloat* p1=marshalf(cpu, ARG3, 1);GL_FUNC(ext_glGetImageTransformParameterfvHP)(ARG1, ARG2, p1);
    marshalBackf(cpu, ARG3, p1, 1);
    GL_LOG ("glGetImageTransformParameterfvHP GLenum target=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetImageTransformParameterivHP(struct CPU* cpu) {
    if (!ext_glGetImageTransformParameterivHP)
        kpanic("ext_glGetImageTransformParameterivHP is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, 1);GL_FUNC(ext_glGetImageTransformParameterivHP)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, 1);
    GL_LOG ("glGetImageTransformParameterivHP GLenum target=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetInfoLogARB(struct CPU* cpu) {
    if (!ext_glGetInfoLogARB)
        kpanic("ext_glGetInfoLogARB is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG3, 1);GLcharARB* p2=marshalub(cpu, ARG4, ARG2);GL_FUNC(ext_glGetInfoLogARB)(hARG1, ARG2, p1, p2);
    marshalBacki(cpu, ARG3, p1, 1);marshalBackub(cpu, ARG4, p2, ARG2);
...
void glcommon_glGetInstrumentsSGIX(struct CPU* cpu) {
...
void glcommon_glGetInteger64i_v(struct CPU* cpu) {
    if (!ext_glGetInteger64i_v)
        kpanic("ext_glGetInteger64i_v is NULL");
    {
    GLint64* p1=marshali64(cpu, ARG3, getSize(ARG1));GL_FUNC(ext_glGetInteger64i_v)(ARG1, ARG2, p1);
    marshalBacki64(cpu, ARG3, p1, getSize(ARG1));
    GL_LOG ("glGetInteger64i_v GLenum target=%d, GLuint index=%d, GLint64* data=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetInteger64v(struct CPU* cpu) {
    if (!ext_glGetInteger64v)
        kpanic("ext_glGetInteger64v is NULL");
    {
    GLint64* p1=marshali64(cpu, ARG2, getSize(ARG1));GL_FUNC(ext_glGetInteger64v)(ARG1, p1);
    marshalBacki64(cpu, ARG2, p1, getSize(ARG1));
    GL_LOG ("glGetInteger64v GLenum pname=%d, GLint64* data=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGetIntegerIndexedvEXT(struct CPU* cpu) {
    if (!ext_glGetIntegerIndexedvEXT)
        kpanic("ext_glGetIntegerIndexedvEXT is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, getSize(ARG1));GL_FUNC(ext_glGetIntegerIndexedvEXT)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, getSize(ARG1));
    GL_LOG ("glGetIntegerIndexedvEXT GLenum target=%d, GLuint index=%d, GLint* data=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetIntegeri_v(struct CPU* cpu) {
    if (!ext_glGetIntegeri_v)
        kpanic("ext_glGetIntegeri_v is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, getSize(ARG1));GL_FUNC(ext_glGetIntegeri_v)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, getSize(ARG1));
    GL_LOG ("glGetIntegeri_v GLenum target=%d, GLuint index=%d, GLint* data=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetIntegerui64i_vNV(struct CPU* cpu) {
    if (!ext_glGetIntegerui64i_vNV)
        kpanic("ext_glGetIntegerui64i_vNV is NULL");
    {
    GLuint64EXT* p1=marshalui64(cpu, ARG3, getSize(ARG1));GL_FUNC(ext_glGetIntegerui64i_vNV)(ARG1, ARG2, p1);
    marshalBackui64(cpu, ARG3, p1, getSize(ARG1));
    GL_LOG ("glGetIntegerui64i_vNV GLenum value=%d, GLuint index=%d, GLuint64EXT* result=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetIntegerui64vNV(struct CPU* cpu) {
    if (!ext_glGetIntegerui64vNV)
        kpanic("ext_glGetIntegerui64vNV is NULL");
    {
    GLuint64EXT* p1=marshalui64(cpu, ARG2, getSize(ARG1));GL_FUNC(ext_glGetIntegerui64vNV)(ARG1, p1);
    marshalBackui64(cpu, ARG2, p1, getSize(ARG1));
    GL_LOG ("glGetIntegerui64vNV GLenum value=%d, GLuint64EXT* result=%.08x",ARG1,ARG2);
    }
}
void glcommon_glGetInternalformatSampleivNV(struct CPU* cpu) {
    if (!ext_glGetInternalformatSampleivNV)
        kpanic("ext_glGetInternalformatSampleivNV is NULL");
    {
    GLint* p1=marshali(cpu, ARG6, ARG5);GL_FUNC(ext_glGetInternalformatSampleivNV)(ARG1, ARG2, ARG3, ARG4, ARG5, p1);
    marshalBacki(cpu, ARG6, p1, ARG5);
...
void glcommon_glGetInternalformati64v(struct CPU* cpu) {
    if (!ext_glGetInternalformati64v)
        kpanic("ext_glGetInternalformati64v is NULL");
    {
    GLint64* p1=marshali64(cpu, ARG5, ARG4);GL_FUNC(ext_glGetInternalformati64v)(ARG1, ARG2, ARG3, ARG4, p1);
    marshalBacki64(cpu, ARG5, p1, ARG4);
...
void glcommon_glGetInternalformativ(struct CPU* cpu) {
    if (!ext_glGetInternalformativ)
        kpanic("ext_glGetInternalformativ is NULL");
    {
    GLint* p1=marshali(cpu, ARG5, ARG4);GL_FUNC(ext_glGetInternalformativ)(ARG1, ARG2, ARG3, ARG4, p1);
    marshalBacki(cpu, ARG5, p1, ARG4);
...
void glcommon_glGetListParameterfvSGIX(struct CPU* cpu) {
...
void glcommon_glGetListParameterivSGIX(struct CPU* cpu) {
...
void glcommon_glGetLocalConstantBooleanvEXT(struct CPU* cpu) {
...
void glcommon_glGetLocalConstantFloatvEXT(struct CPU* cpu) {
...
void glcommon_glGetLocalConstantIntegervEXT(struct CPU* cpu) {
...
void glcommon_glGetMapAttribParameterfvNV(struct CPU* cpu) {
...
void glcommon_glGetMapAttribParameterivNV(struct CPU* cpu) {
...
void glcommon_glGetMapControlPointsNV(struct CPU* cpu) {
...
void glcommon_glGetMapParameterfvNV(struct CPU* cpu) {
...
void glcommon_glGetMapParameterivNV(struct CPU* cpu) {
...
void glcommon_glGetMapxvOES(struct CPU* cpu) {
...
void glcommon_glGetMaterialxOES(struct CPU* cpu) {
...
void glcommon_glGetMinmax(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glGetMinmax)(ARG1, bARG2, ARG3, ARG4, (void*)marshalp(cpu, 0, ARG5, 0));
...
void glcommon_glGetMinmaxEXT(struct CPU* cpu) {
    if (!ext_glGetMinmaxEXT)
        kpanic("ext_glGetMinmaxEXT is NULL");
    {
    GL_FUNC(ext_glGetMinmaxEXT)(ARG1, bARG2, ARG3, ARG4, (void*)marshalp(cpu, 0, ARG5, 0));
...
void glcommon_glGetMinmaxParameterfv(struct CPU* cpu) {
    ...
    {
    GL_FUNC(ext_glGetMinmaxParameterfv)(ARG1, ARG2, (GLfloat*)marshalp(cpu, 0, ARG3, 0));
    GL_LOG ("glGetMinmaxParameterfv GLenum target=%d, GLenum pname=%d, GLfloat* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetMinmaxParameterfvEXT(struct CPU* cpu) {
    if (!ext_glGetMinmaxParameterfvEXT)
        kpanic("ext_glGetMinmaxParameterfvEXT is NULL");
    {
    GL_FUNC(ext_glGetMinmaxParameterfvEXT)(ARG1, ARG2, (GLfloat*)marshalp(cpu, 0, ARG3, 0));
...
void glcommon_glGetMultiTexEnvivEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexGendvEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexGenfvEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexGenivEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexImageEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexLevelParameterfvEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexLevelParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexParameterIivEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexParameterIuivEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexParameterfvEXT(struct CPU* cpu) {
...
void glcommon_glGetMultiTexParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetMultisamplefv(struct CPU* cpu) {
...
void glcommon_glGetMultisamplefvNV(struct CPU* cpu) {
...
void glcommon_glGetNamedBufferParameteri64v(struct CPU* cpu) {
...
void glcommon_glGetNamedBufferParameteriv(struct CPU* cpu) {
...
void glcommon_glGetNamedBufferParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedBufferParameterui64vNV(struct CPU* cpu) {
...
void glcommon_glGetNamedBufferPointerv(struct CPU* cpu) {
...
void glcommon_glGetNamedBufferPointervEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedBufferSubData(struct CPU* cpu) {
...
void glcommon_glGetNamedBufferSubDataEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedFramebufferAttachmentParameteriv(struct CPU* cpu) {
...
void glcommon_glGetNamedFramebufferAttachmentParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedFramebufferParameteriv(struct CPU* cpu) {
...
void glcommon_glGetNamedFramebufferParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedProgramLocalParameterIivEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedProgramLocalParameterIuivEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedProgramLocalParameterdvEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedProgramLocalParameterfvEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedProgramStringEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedProgramivEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedRenderbufferParameteriv(struct CPU* cpu) {
...
void glcommon_glGetNamedRenderbufferParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetNamedStringARB(struct CPU* cpu) {
...
void glcommon_glGetNamedStringivARB(struct CPU* cpu) {
...
void glcommon_glGetNextPerfQueryIdINTEL(struct CPU* cpu) {
...
void glcommon_glGetObjectBufferfvATI(struct CPU* cpu) {
...
void glcommon_glGetObjectBufferivATI(struct CPU* cpu) {
...
void glcommon_glGetObjectLabel(struct CPU* cpu) {
...
void glcommon_glGetObjectLabelEXT(struct CPU* cpu) {
...
void glcommon_glGetObjectParameterfvARB(struct CPU* cpu) {
...
void glcommon_glGetObjectParameterivAPPLE(struct CPU* cpu) {
...
void glcommon_glGetObjectParameterivARB(struct CPU* cpu) {
...
void glcommon_glGetObjectPtrLabel(struct CPU* cpu) {
...
void glcommon_glGetOcclusionQueryivNV(struct CPU* cpu) {
...
void glcommon_glGetOcclusionQueryuivNV(struct CPU* cpu) {
...
void glcommon_glGetPathColorGenfvNV(struct CPU* cpu) {
...
void glcommon_glGetPathColorGenivNV(struct CPU* cpu) {
...
void glcommon_glGetPathCommandsNV(struct CPU* cpu) {
...
void glcommon_glGetPathCoordsNV(struct CPU* cpu) {
...
void glcommon_glGetPathDashArrayNV(struct CPU* cpu) {
...
void glcommon_glGetPathLengthNV(struct CPU* cpu) {
...
void glcommon_glGetPathMetricRangeNV(struct CPU* cpu) {
...
void glcommon_glGetPathMetricsNV(struct CPU* cpu) {
...
void glcommon_glGetPathParameterfvNV(struct CPU* cpu) {
...
void glcommon_glGetPathParameterivNV(struct CPU* cpu) {
...
void glcommon_glGetPathSpacingNV(struct CPU* cpu) {
...
void glcommon_glGetPathTexGenfvNV(struct CPU* cpu) {
...
void glcommon_glGetPathTexGenivNV(struct CPU* cpu) {
...
void glcommon_glGetPerfCounterInfoINTEL(struct CPU* cpu) {
...
void glcommon_glGetPerfMonitorCounterDataAMD(struct CPU* cpu) {
...
void glcommon_glGetPerfMonitorCounterInfoAMD(struct CPU* cpu) {
...
void glcommon_glGetPerfMonitorCounterStringAMD(struct CPU* cpu) {
...
void glcommon_glGetPerfMonitorCountersAMD(struct CPU* cpu) {
...
void glcommon_glGetPerfMonitorGroupStringAMD(struct CPU* cpu) {
...
void glcommon_glGetPerfMonitorGroupsAMD(struct CPU* cpu) {
...
void glcommon_glGetPerfQueryDataINTEL(struct CPU* cpu) {
...
void glcommon_glGetPerfQueryIdByNameINTEL(struct CPU* cpu) {
...
void glcommon_glGetPerfQueryInfoINTEL(struct CPU* cpu) {
...
void glcommon_glGetPixelMapxv(struct CPU* cpu) {
...
void glcommon_glGetPixelTexGenParameterfvSGIS(struct CPU* cpu) {
...
void glcommon_glGetPixelTexGenParameterivSGIS(struct CPU* cpu) {
...
void glcommon_glGetPixelTransformParameterfvEXT(struct CPU* cpu) {
...
void glcommon_glGetPixelTransformParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetPointerIndexedvEXT(struct CPU* cpu) {
...
void glcommon_glGetPointeri_vEXT(struct CPU* cpu) {
...
void glcommon_glGetPointervEXT(struct CPU* cpu) {
...
void glcommon_glGetProgramBinary(struct CPU* cpu) {
...
void glcommon_glGetProgramEnvParameterIivNV(struct CPU* cpu) {
...
void glcommon_glGetProgramEnvParameterIuivNV(struct CPU* cpu) {
...
void glcommon_glGetProgramEnvParameterdvARB(struct CPU* cpu) {
...
void glcommon_glGetProgramEnvParameterfvARB(struct CPU* cpu) {
...
void glcommon_glGetProgramInfoLog(struct CPU* cpu) {
    if (!ext_glGetProgramInfoLog)
        kpanic("ext_glGetProgramInfoLog is NULL");
    {
    GL_FUNC(ext_glGetProgramInfoLog)(ARG1, ARG2, (GLsizei*)marshalp(cpu, 0, ARG3, 0), (GLchar*)marshalp(cpu, 0, ARG4, 0));
    GL_LOG ("glGetProgramInfoLog GLuint program=%d, GLsizei bufSize=%d, GLsizei* length=%.08x, GLchar* infoLog=%.08x",ARG1,ARG2,ARG3,ARG4);
    }
}
void glcommon_glGetProgramInterfaceiv(struct CPU* cpu) {
...
void glcommon_glGetProgramLocalParameterIivNV(struct CPU* cpu) {
...
void glcommon_glGetProgramLocalParameterIuivNV(struct CPU* cpu) {
...
void glcommon_glGetProgramLocalParameterdvARB(struct CPU* cpu) {
...
void glcommon_glGetProgramLocalParameterfvARB(struct CPU* cpu) {
...
void glcommon_glGetProgramNamedParameterdvNV(struct CPU* cpu) {
...
void glcommon_glGetProgramNamedParameterfvNV(struct CPU* cpu) {
...
void glcommon_glGetProgramParameterdvNV(struct CPU* cpu) {
...
void glcommon_glGetProgramParameterfvNV(struct CPU* cpu) {
...
void glcommon_glGetProgramPipelineInfoLog(struct CPU* cpu) {
...
void glcommon_glGetProgramPipelineiv(struct CPU* cpu) {
...
void glcommon_glGetProgramResourceIndex(struct CPU* cpu) {
...
void glcommon_glGetProgramResourceLocation(struct CPU* cpu) {
...
void glcommon_glGetProgramResourceLocationIndex(struct CPU* cpu) {
...
void glcommon_glGetProgramResourceName(struct CPU* cpu) {
...
void glcommon_glGetProgramResourcefvNV(struct CPU* cpu) {
...
void glcommon_glGetProgramResourceiv(struct CPU* cpu) {
...
void glcommon_glGetProgramStageiv(struct CPU* cpu) {
...
void glcommon_glGetProgramStringARB(struct CPU* cpu) {
...
void glcommon_glGetProgramStringNV(struct CPU* cpu) {
...
void glcommon_glGetProgramSubroutineParameteruivNV(struct CPU* cpu) {
...
void glcommon_glGetQueryBufferObjectiv(struct CPU* cpu) {
...
void glcommon_glGetQueryBufferObjectui64v(struct CPU* cpu) {
...
void glcommon_glGetQueryBufferObjectuiv(struct CPU* cpu) {
...
void glcommon_glGetQueryIndexediv(struct CPU* cpu) {
...
void glcommon_glGetQueryObjecti64v(struct CPU* cpu) {
...
void glcommon_glGetQueryObjecti64vEXT(struct CPU* cpu) {
...
void glcommon_glGetQueryObjectiv(struct CPU* cpu) {
...
void glcommon_glGetQueryObjectivARB(struct CPU* cpu) {
...
void glcommon_glGetQueryObjectui64v(struct CPU* cpu) {
...
void glcommon_glGetQueryObjectui64vEXT(struct CPU* cpu) {
...
void glcommon_glGetQueryObjectuiv(struct CPU* cpu) {
...
void glcommon_glGetQueryObjectuivARB(struct CPU* cpu) {
...
void glcommon_glGetQueryiv(struct CPU* cpu) {
    if (!ext_glGetQueryiv)
        kpanic("ext_glGetQueryiv is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, 1);GL_FUNC(ext_glGetQueryiv)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, 1);
    GL_LOG ("glGetQueryiv GLenum target=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetQueryivARB(struct CPU* cpu) {
    if (!ext_glGetQueryivARB)
        kpanic("ext_glGetQueryivARB is NULL");
    {
    GLint* p1=marshali(cpu, ARG3, 1);GL_FUNC(ext_glGetQueryivARB)(ARG1, ARG2, p1);
    marshalBacki(cpu, ARG3, p1, 1);
    GL_LOG ("glGetQueryivARB GLenum target=%d, GLenum pname=%d, GLint* params=%.08x",ARG1,ARG2,ARG3);
    }
}
void glcommon_glGetRenderbufferParameteriv(struct CPU* cpu) {
...
void glcommon_glGetRenderbufferParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetSamplerParameterIiv(struct CPU* cpu) {
...
void glcommon_glGetSamplerParameterIuiv(struct CPU* cpu) {
...
void glcommon_glGetSamplerParameterfv(struct CPU* cpu) {
...
void glcommon_glGetSamplerParameteriv(struct CPU* cpu) {
...
void glcommon_glGetSeparableFilterEXT(struct CPU* cpu) {
...
void glcommon_glGetShaderInfoLog(struct CPU* cpu) {
...
void glcommon_glGetShaderPrecisionFormat(struct CPU* cpu) {
...
void glcommon_glGetShaderSource(struct CPU* cpu) {
    if (!ext_glGetShaderSource)
        kpanic("ext_glGetShaderSource is NULL");
    {
    GLsizei* p1=marshali(cpu, ARG3, 1);GLchar* p2=marshalub(cpu, ARG4, ARG2);GL_FUNC(ext_glGetShaderSource)(ARG1, ARG2, p1, p2);
    marshalBacki(cpu, ARG3, p1, 1);marshalBackub(cpu, ARG4, p2, ARG2);
    GL_LOG ("glGetShaderSource GLuint shader=%d, GLsizei bufSize=%d, GLsizei* length=%.08x, GLchar* source=%.08x",ARG1,ARG2,ARG3,ARG4);
    }
}
void glcommon_glGetShaderSourceARB(struct CPU* cpu) {
...
void glcommon_glGetShaderiv(struct CPU* cpu) {
...
void glcommon_glGetSharpenTexFuncSGIS(struct CPU* cpu) {
...
void glcommon_glGetStageIndexNV(struct CPU* cpu) {
...
void glcommon_glGetSubroutineIndex(struct CPU* cpu) {
...
void glcommon_glGetSubroutineUniformLocation(struct CPU* cpu) {
...
void glcommon_glGetSynciv(struct CPU* cpu) {
    if (!ext_glGetSynciv)
...
void glcommon_glGetTexBumpParameterfvATI(struct CPU* cpu) {
...
void glcommon_glGetTexBumpParameterivATI(struct CPU* cpu) {
...
void glcommon_glGetTexEnvxvOES(struct CPU* cpu) {
...
void glcommon_glGetTexFilterFuncSGIS(struct CPU* cpu) {
...
void glcommon_glGetTexGenxvOES(struct CPU* cpu) {
...
void glcommon_glGetTexLevelParameterxvOES(struct CPU* cpu) {
...
void glcommon_glGetTexParameterIiv(struct CPU* cpu) {
...
void glcommon_glGetTexParameterIivEXT(struct CPU* cpu) {
...
void glcommon_glGetTexParameterIuiv(struct CPU* cpu) {
...
void glcommon_glGetTexParameterIuivEXT(struct CPU* cpu) {
...
void glcommon_glGetTexParameterPointervAPPLE(struct CPU* cpu) {
...
void glcommon_glGetTexParameterxvOES(struct CPU* cpu) {
...
void glcommon_glGetTextureHandleARB(struct CPU* cpu) {
...
void glcommon_glGetTextureHandleNV(struct CPU* cpu) {
...
void glcommon_glGetTextureImage(struct CPU* cpu) {
...
void glcommon_glGetTextureImageEXT(struct CPU* cpu) {
...
void glcommon_glGetTextureLevelParameterfv(struct CPU* cpu) {
...
void glcommon_glGetTextureLevelParameterfvEXT(struct CPU* cpu) {
...
void glcommon_glGetTextureLevelParameteriv(struct CPU* cpu) {
...
void glcommon_glGetTextureLevelParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetTextureParameterIiv(struct CPU* cpu) {
...
void glcommon_glGetTextureParameterIivEXT(struct CPU* cpu) {
...
void glcommon_glGetTextureParameterIuiv(struct CPU* cpu) {
...
void glcommon_glGetTextureParameterIuivEXT(struct CPU* cpu) {
...
void glcommon_glGetTextureParameterfv(struct CPU* cpu) {
...
void glcommon_glGetTextureParameterfvEXT(struct CPU* cpu) {
...
void glcommon_glGetTextureParameteriv(struct CPU* cpu) {
...
void glcommon_glGetTextureParameterivEXT(struct CPU* cpu) {
...
void glcommon_glGetTextureSamplerHandleARB(struct CPU* cpu) {
...
void glcommon_glGetTextureSamplerHandleNV(struct CPU* cpu) {
...
void glcommon_glGetTextureSubImage(struct CPU* cpu) {
...
void glcommon_glGetTrackMatrixivNV(struct CPU* cpu) {
...
void glcommon_glGetTransformFeedbackVarying(struct CPU* cpu) {
...
void glcommon_glGetTransformFeedbackVaryingEXT(struct CPU* cpu) {
...
void glcommon_glGetTransformFeedbackVaryingNV(struct CPU* cpu) {
...
void glcommon_glGetTransformFeedbacki64_v(struct CPU* cpu) {
...
void glcommon_glGetTransformFeedbacki_v(struct CPU* cpu) {
...
void glcommon_glGetTransformFeedbackiv(struct CPU* cpu) {
...
void glcommon_glGetUniformBlockIndex(struct CPU* cpu) {
...
void glcommon_glGetUniformBufferSizeEXT(struct CPU* cpu) {
...
void glcommon_glGetUniformIndices(struct CPU* cpu) {
    if (!ext_glGetUniformIndices)
        kpanic("ext_glGetUniformIndices is NULL");
    {
    GL_FUNC(ext_glGetUniformIndices)(ARG1, ARG2, (GLchar*const*)marshalpp(cpu, ARG3, ARG2, 0, -1), (GLuint*)marshalp(cpu, 0, ARG4, 0));
...
void glcommon_glGetUniformLocation(struct CPU* cpu) {
...
void glcommon_glGetUniformLocationARB(struct CPU* cpu) {
...
void glcommon_glGetUniformOffsetEXT(struct CPU* cpu) {
...
void glcommon_glGetUniformSubroutineuiv(struct CPU* cpu) {
...
void glcommon_glGetUniformdv(struct CPU* cpu) {
