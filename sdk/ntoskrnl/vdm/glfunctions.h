...
GL_FUNCTION(Clear, void, (GLbitfield mask), (ARG1),,,("glClear"))
...
GL_FUNCTION(GetPolygonStipple, void, (GLubyte *mask), (p), GLubyte buffer[128];GLboolean b=PIXEL_PACK_BUFFER();GLubyte* p; if(b)p=(GLubyte*)ARG1; else p=buffer;, if (!b) marshalBackub(cpu, ARG1, buffer, 128);,("glGetPolygonStipple"))
...
GL_FUNCTION(PolygonStipple, void, (const GLubyte *mask), (PIXEL_UNPACK_BUFFER()?(GLubyte*)ARG1:marshalub(cpu, ARG1, 128)),,,("glPolygonStipple"))
GL_FUNCTION(EdgeFlag, void, (GLboolean flag), (ARG1),,,("glEdgeFlag"))
GL_FUNCTION(EdgeFlagv, void, (const GLboolean *flag), (marshalbool(cpu, ARG1, 1)),,,("glEdgeFlagv"))
GL_FUNCTION(Scissor, void, (GLint x, GLint y, GLsizei width, GLsizei height), (ARG1, ARG2, ARG3, ARG4),,,("glScissor"))
GL_FUNCTION(ClipPlane, void, (GLenum plane, const GLdouble *equation), (ARG1, marshald(cpu, ARG2, 4)),,,("glClipPlane"))
GL_FUNCTION(GetClipPlane, void, (GLenum plane, GLdouble *equation), (ARG1, buffer), GLdouble buffer[4];, marshalBackd(cpu, ARG2, buffer, 4);,("glGetClipPlane"))
...
GL_FUNCTION(RenderMode, GLint, (GLenum mode), (ARG1),EAX=,,("glRenderMode mode=%d ret=%d", ARG1, EAX))
GL_FUNCTION(GetError, GLenum, (), (),EAX=,,("glGetError ret=%x",EAX))
...
GL_FUNCTION(Viewport, void, (GLint x, GLint y, GLsizei width, GLsizei height), (ARG1, ARG2, ARG3, ARG4),,,("glViewport"))
...
GL_FUNCTION(LoadMatrixd, void, (const GLdouble *m), (marshald(cpu, ARG1, 16)),,,("glLoadMatrixd"))
GL_FUNCTION(LoadMatrixf, void, (const GLfloat *m), (marshalf(cpu, ARG1, 16)),,,("glLoadMatrixf"))
GL_FUNCTION(MultMatrixd, void, (const GLdouble *m), (marshald(cpu, ARG1, 16)),,,("glMultMatrixd"))
GL_FUNCTION(MultMatrixf, void, (const GLfloat *m), (marshalf(cpu, ARG1, 16)),,,("glMultMatrixf"))
...
GL_FUNCTION(Vertex2dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 2)),,,("glVertex2dv"))
GL_FUNCTION(Vertex2fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 2)),,,("glVertex2fv"))
GL_FUNCTION(Vertex2iv, void, (const GLint *v), (marshali(cpu, ARG1, 2)),,,("glVertex2iv"))
GL_FUNCTION(Vertex2sv, void, (const GLshort *v), (marshals(cpu, ARG1, 2)),,,("glVertex2sv"))
GL_FUNCTION(Vertex3dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 3)),,,("glVertex3dv"))
GL_FUNCTION(Vertex3fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 3)),,,("glVertex3fv"))
GL_FUNCTION(Vertex3iv, void, (const GLint *v), (marshali(cpu, ARG1, 3)),,,("glVertex3iv"))
GL_FUNCTION(Vertex3sv, void, (const GLshort *v), (marshals(cpu, ARG1, 3)),,,("glVertex3sv"))
GL_FUNCTION(Vertex4dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 4)),,,("glVertex4dv"))
GL_FUNCTION(Vertex4fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 4)),,,("glVertex4fv"))
GL_FUNCTION(Vertex4iv, void, (const GLint *v), (marshali(cpu, ARG1, 4)),,,("glVertex4iv"))
GL_FUNCTION(Vertex4sv, void, (const GLshort *v), (marshals(cpu, ARG1, 4)),,,("glVertex4sv"))
...
GL_FUNCTION(Normal3bv, void, (const GLbyte *v), (marshalb(cpu, ARG1, 3)),,,("glNormal3bv"))
GL_FUNCTION(Normal3dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 3)),,,("glNormal3dv"))
GL_FUNCTION(Normal3fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 3)),,,("glNormal3fv"))
GL_FUNCTION(Normal3iv, void, (const GLint *v), (marshali(cpu, ARG1, 3)),,,("glNormal3iv"))
GL_FUNCTION(Normal3sv, void, (const GLshort *v), (marshals(cpu, ARG1, 3)),,,("glNormal3sv"))
...
GL_FUNCTION(Indexdv, void, (const GLdouble *c), (marshald(cpu, ARG1, 1)),,,("glIndexdv"))
GL_FUNCTION(Indexfv, void, (const GLfloat *c), (marshalf(cpu, ARG1, 1)),,,("glIndexfv"))
GL_FUNCTION(Indexiv, void, (const GLint *c), (marshali(cpu, ARG1, 1)),,,("glIndexiv"))
GL_FUNCTION(Indexsv, void, (const GLshort *c), (marshals(cpu, ARG1, 1)),,,("glIndexsv"))
GL_FUNCTION(Indexubv, void, (const GLubyte *c), (marshalub(cpu, ARG1, 1)),,,("glIndexubv"))
...
GL_FUNCTION(Color3bv, void, (const GLbyte *v), (marshalb(cpu, ARG1, 3)),,,("glColor3bv"))
GL_FUNCTION(Color3dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 3)),,,("glColor3dv"))
GL_FUNCTION(Color3fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 3)),,,("glColor3fv"))
GL_FUNCTION(Color3iv, void, (const GLint *v), (marshali(cpu, ARG1, 3)),,,("glColor3iv"))
GL_FUNCTION(Color3sv, void, (const GLshort *v), (marshals(cpu, ARG1, 3)),,,("glColor3sv"))
GL_FUNCTION(Color3ubv, void, (const GLubyte *v), (marshalub(cpu, ARG1, 3)),,,("glColor3ubv"))
GL_FUNCTION(Color3uiv, void, (const GLuint *v), (marshalui(cpu, ARG1, 3)),,,("glColor3uiv"))
GL_FUNCTION(Color3usv, void, (const GLushort *v), (marshalus(cpu, ARG1, 3)),,,("glColor3usv"))
GL_FUNCTION(Color4bv, void, (const GLbyte *v), (marshalb(cpu, ARG1, 4)),,,("glColor4bv"))
GL_FUNCTION(Color4dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 4)),,,("glColor4dv"))
GL_FUNCTION(Color4fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 4)),,,("glColor4fv"))
GL_FUNCTION(Color4iv, void, (const GLint *v), (marshali(cpu, ARG1, 4)),,,("glColor4iv"))
GL_FUNCTION(Color4sv, void, (const GLshort *v), (marshals(cpu, ARG1, 4)),,,("glColor4sv"))
GL_FUNCTION(Color4ubv, void, (const GLubyte *v), (marshalub(cpu, ARG1, 4)),,,("glColor4ubv"))
GL_FUNCTION(Color4uiv, void, (const GLuint *v), (marshalui(cpu, ARG1, 4)),,,("glColor4uiv"))
GL_FUNCTION(Color4usv, void, (const GLushort *v), (marshalus(cpu, ARG1, 4)),,,("glColor4usv"))
...
GL_FUNCTION(TexCoord1dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 1)),,,("glTexCoord1dv"))
GL_FUNCTION(TexCoord1fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 1)),,,("glTexCoord1fv"))
GL_FUNCTION(TexCoord1iv, void, (const GLint *v), (marshali(cpu, ARG1, 1)),,,("glTexCoord1iv"))
GL_FUNCTION(TexCoord1sv, void, (const GLshort *v), (marshals(cpu, ARG1, 1)),,,("glTexCoord1sv"))
GL_FUNCTION(TexCoord2dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 2)),,,("glTexCoord2dv"))
GL_FUNCTION(TexCoord2fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 2)),,,("glTexCoord2fv"))
GL_FUNCTION(TexCoord2iv, void, (const GLint *v), (marshali(cpu, ARG1, 2)),,,("glTexCoord2iv"))
GL_FUNCTION(TexCoord2sv, void, (const GLshort *v), (marshals(cpu, ARG1, 2)),,,("glTexCoord2sv"))
GL_FUNCTION(TexCoord3dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 3)),,,("glTexCoord3dv"))
GL_FUNCTION(TexCoord3fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 3)),,,("glTexCoord3fv"))
GL_FUNCTION(TexCoord3iv, void, (const GLint *v), (marshali(cpu, ARG1, 3)),,,("glTexCoord3iv"))
GL_FUNCTION(TexCoord3sv, void, (const GLshort *v), (marshals(cpu, ARG1, 3)),,,("glTexCoord3sv"))
GL_FUNCTION(TexCoord4dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 4)),,,("glTexCoord4dv"))
GL_FUNCTION(TexCoord4fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 4)),,,("glTexCoord4fv"))
GL_FUNCTION(TexCoord4iv, void, (const GLint *v), (marshali(cpu, ARG1, 4)),,,("glTexCoord4iv"))
GL_FUNCTION(TexCoord4sv, void, (const GLshort *v), (marshals(cpu, ARG1, 4)),,,("glTexCoord4sv"))
...
GL_FUNCTION(RasterPos2dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 2)),,,("glRasterPos2dv"))
GL_FUNCTION(RasterPos2fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 2)),,,("glRasterPos2fv"))
GL_FUNCTION(RasterPos2iv, void, (const GLint *v), (marshali(cpu, ARG1, 2)),,,("glRasterPos2iv"))
GL_FUNCTION(RasterPos2sv, void, (const GLshort *v), (marshals(cpu, ARG1, 2)),,,("glRasterPos2sv"))
GL_FUNCTION(RasterPos3dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 3)),,,("glRasterPos3dv"))
GL_FUNCTION(RasterPos3fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 3)),,,("glRasterPos3fv"))
GL_FUNCTION(RasterPos3iv, void, (const GLint *v), (marshali(cpu, ARG1, 3)),,,("glRasterPos3iv"))
GL_FUNCTION(RasterPos3sv, void, (const GLshort *v), (marshals(cpu, ARG1, 3)),,,("glRasterPos3sv"))
GL_FUNCTION(RasterPos4dv, void, (const GLdouble *v), (marshald(cpu, ARG1, 4)),,,("glRasterPos4dv"))
GL_FUNCTION(RasterPos4fv, void, (const GLfloat *v), (marshalf(cpu, ARG1, 4)),,,("glRasterPos4fv"))
GL_FUNCTION(RasterPos4iv, void, (const GLint *v), (marshali(cpu, ARG1, 4)),,,("glRasterPos4iv"))
GL_FUNCTION(RasterPos4sv, void, (const GLshort *v), (marshals(cpu, ARG1, 4)),,,("glRasterPos4sv"))
...
GL_FUNCTION(Rectdv, void, (const GLdouble *v1, const GLdouble *v2), (marshald(cpu, ARG1, 2), marshal2d(cpu, ARG3, 2)),,,("glRectdv"))
GL_FUNCTION(Rectfv, void, (const GLfloat *v1, const GLfloat *v2), (marshalf(cpu, ARG1, 2), marshal2f(cpu, ARG2, 2)),,,("glRectfv"))
GL_FUNCTION(Rectiv, void, (const GLint *v1, const GLint *v2), (marshali(cpu, ARG1, 2), marshal2i(cpu, ARG2, 2)),,,("glRectiv"))
GL_FUNCTION(Rectsv, void, (const GLshort *v1, const GLshort *v2), (marshals(cpu, ARG1, 2), marshal2s(cpu, ARG2, 2)),,,("glRectsv"))
...
GL_FUNCTION(Lightfv, void, (GLenum light, GLenum pname, const GLfloat *params), (ARG1, ARG2, marshalf(cpu, ARG3, glcommon_glLightv_size(ARG2))),,,("glLightfv"))
GL_FUNCTION(Lightiv, void, (GLenum light, GLenum pname, const GLint *params), (ARG1, ARG2, marshali(cpu, ARG3, glcommon_glLightv_size(ARG2))),,,("glLightiv"))
...
GL_FUNCTION(LightModelfv, void, (GLenum pname, const GLfloat *params), (ARG1, marshalf(cpu, ARG2, glcommon_glLightModelv_size(ARG1))),,,("glLightModelfv"))
GL_FUNCTION(LightModeliv, void, (GLenum pname, const GLint *params), (ARG1, marshali(cpu, ARG2, glcommon_glLightModelv_size(ARG1))),,,("glLightModeliv"))
...
GL_FUNCTION(Materialfv, void, (GLenum face, GLenum pname, const GLfloat *params), (ARG1, ARG2, marshalf(cpu, ARG3, glcommon_glMaterialv_size(ARG2))),,,("glMaterialfv"))
GL_FUNCTION(Materialiv, void, (GLenum face, GLenum pname, const GLint *params), (ARG1, ARG2, marshali(cpu, ARG3, glcommon_glMaterialv_size(ARG2))),,,("glMaterialiv"))
...
GL_FUNCTION(PixelMapfv, void, (GLenum map, GLint mapsize, const GLfloat *values), (ARG1, ARG2, PIXEL_UNPACK_BUFFER()?(GLfloat*)ARG3:marshalf(cpu, ARG3, ARG2)),,,("glPixelMapfv"))
GL_FUNCTION(PixelMapuiv, void, (GLenum map, GLint mapsize, const GLuint *values), (ARG1, ARG2, PIXEL_UNPACK_BUFFER()?(GLuint*)ARG3:marshalui(cpu, ARG3, ARG2)),,,("glPixelMapuiv"))
GL_FUNCTION(PixelMapusv, void, (GLenum map, GLint mapsize, const GLushort *values), (ARG1, ARG2, PIXEL_UNPACK_BUFFER()?(GLushort*)ARG3:marshalus(cpu, ARG3, ARG2)),,,("glPixelMapusv"))
GL_FUNCTION(Bitmap, void, (GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap), (ARG1, ARG2, fARG3, fARG4, fARG5, fARG6, PIXEL_UNPACK_BUFFER()?(GLubyte*)ARG7:marshalPixels(cpu, 0, ARG1, ARG2, 1, GL_COLOR_INDEX, GL_BITMAP, ARG7)),,,("glBitmap"))
GL_FUNCTION(DrawPixels, void, (GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels), (ARG1, ARG2, ARG3, ARG4, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG5:marshalPixels(cpu, 0, ARG1, ARG2, 1, ARG3, ARG4, ARG5)),,,("glDrawPixels"))
...
GL_FUNCTION(TexGendv, void, (GLenum coord, GLenum pname, const GLdouble *params), (ARG1, ARG2, marshald(cpu, ARG3, (ARG2==GL_OBJECT_PLANE || ARG2==GL_EYE_PLANE)?4:1)),,,("glTexGendv"))
GL_FUNCTION(TexGenfv, void, (GLenum coord, GLenum pname, const GLfloat *params), (ARG1, ARG2, marshalf(cpu, ARG3,  (ARG2==GL_OBJECT_PLANE || ARG2==GL_EYE_PLANE)?4:1)),,,("glTexGenfv"))
GL_FUNCTION(TexGeniv, void, (GLenum coord, GLenum pname, const GLint *params), (ARG1, ARG2, marshali(cpu, ARG3,  (ARG2==GL_OBJECT_PLANE || ARG2==GL_EYE_PLANE)?4:1)),,,("glTexGeniv"))
...
GL_FUNCTION(TexEnvfv, void, (GLenum target, GLenum pname, const GLfloat *params), (ARG1, ARG2, marshalf(cpu, ARG3, (ARG2==GL_TEXTURE_ENV_COLOR)?4:1)),,,("glTexEnvfv"))
GL_FUNCTION(TexEnviv, void, (GLenum target, GLenum pname, const GLint *params), (ARG1, ARG2, marshali(cpu, ARG3, (ARG2==GL_TEXTURE_ENV_COLOR)?4:1)),,,("glTexEnviv"))
...
GL_FUNCTION(TexParameterfv, void, (GLenum target, GLenum pname, const GLfloat *params), (ARG1, ARG2, marshalf(cpu, ARG3, (ARG2==GL_TEXTURE_BORDER_COLOR)?4:1)),,,("glTexParameterfv"))
GL_FUNCTION(TexParameteriv, void, (GLenum target, GLenum pname, const GLint *params), (ARG1, ARG2, marshali(cpu, ARG3, (ARG2==GL_TEXTURE_BORDER_COLOR)?4:1)),,,("glTexParameteriv"))
GL_FUNCTION(TexImage1D, void, (GLenum target, GLint level, GLint internalFormat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels), (ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG8:marshalPixels(cpu, ARG1 == GL_TEXTURE_3D, ARG4, 1, 1, ARG6, ARG7, ARG8)),,,("glTexImage1D"))
GL_FUNCTION(TexImage2D, void, (GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels), (ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalPixels(cpu, ARG1 == GL_TEXTURE_3D, ARG4, ARG5, 1, ARG7, ARG8, ARG9)),,,("glTexImage2D"))
GL_FUNCTION(Map1d, void, (GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points), (ARG1, dARG2, dARG3, ARG4, ARG5, marshald(cpu, ARG6, getMap1Count(ARG1)*ARG5)),,,("glMap1d"))
GL_FUNCTION(Map1f, void, (GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points), (ARG1, fARG2, fARG3, ARG4, ARG5, marshalf(cpu, ARG6, getMap1Count(ARG1)*ARG5)),,,("glMap1f"))
GL_FUNCTION(Map2d, void, (GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points), (ARG1, dARG2, dARG3, ARG4, ARG5, dARG6, dARG7, ARG8, ARG9, marshald(cpu, ARG10, getMap2Count(ARG1)*ARG5*ARG9)),,,("glMap2d"))
GL_FUNCTION(Map2f, void, (GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points), (ARG1, fARG2, fARG3, ARG4, ARG5, fARG6, fARG7, ARG8, ARG9, marshalf(cpu, ARG10, getMap2Count(ARG1)*ARG5*ARG9)),,,("glMap2f"))
GL_FUNCTION(EvalCoord1d, void, (GLdouble u), (dARG1),,,("glEvalCoord1d"))
GL_FUNCTION(EvalCoord1f, void, (GLfloat u), (fARG1),,,("glEvalCoord1f"))
GL_FUNCTION(EvalCoord1dv, void, (const GLdouble *u), (marshald(cpu, ARG1, 1)),,,("glEvalCoord1dv"))
GL_FUNCTION(EvalCoord1fv, void, (const GLfloat *u), (marshalf(cpu, ARG1, 1)),,,("glEvalCoord1fv"))
...
GL_FUNCTION(EvalCoord2dv, void, (const GLdouble *u), (marshald(cpu, ARG1, 2)),,,("glEvalCoord2dv"))
GL_FUNCTION(EvalCoord2fv, void, (const GLfloat *u), (marshalf(cpu, ARG1, 2)),,,("glEvalCoord2fv"))
...
GL_FUNCTION(Fogfv, void, (GLenum pname, const GLfloat *params), (ARG1, marshalf(cpu, ARG2, (ARG1==GL_FOG_COLOR)?4:1)),,,("glFogfv"))
GL_FUNCTION(Fogiv, void, (GLenum pname, const GLint *params), (ARG1, marshali(cpu, ARG2, (ARG1==GL_FOG_COLOR)?4:1)),,,("glFogiv"))
...
GL_FUNCTION(DeleteTextures, void, (GLsizei n, const GLuint *textures), (ARG1, marshalui(cpu, ARG2, ARG1)),,,("glDeleteTextures"))
GL_FUNCTION(BindTexture, void, (GLenum target, GLuint texture), (ARG1, ARG2),,,("glBindTexture"))
GL_FUNCTION(PrioritizeTextures, void, (GLsizei n, const GLuint *textures, const GLclampf *priorities), (ARG1, marshalui(cpu, ARG2, ARG1), marshal2f(cpu, ARG3, ARG1)),,,("glPrioritizeTextures"))
GL_FUNCTION(IsTexture, GLboolean, (GLuint texture), (ARG1),EAX=,,("glIsTexture"))
GL_FUNCTION(TexSubImage1D, void, (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels), (ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG7:marshalPixels(cpu, ARG1 == GL_TEXTURE_3D, ARG4, 1, 1, ARG5, ARG6, ARG7)),,,("glTexSubImage1D"))
GL_FUNCTION(TexSubImage2D, void, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels), (ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, PIXEL_UNPACK_BUFFER()?(GLvoid*)ARG9:marshalPixels(cpu, ARG1 == GL_TEXTURE_3D, ARG5, ARG6, 1, ARG7, ARG8, ARG9)),,,("glTexSubImage2D"))
...
GL_FUNCTION(DrawElements, void, (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices), (ARG1, ARG2, ARG3, ELEMENT_ARRAY_BUFFER()?(GLvoid*)ARG4:marshalType(cpu, ARG3, ARG2, ARG4)), updateVertexPointers(cpu, ARG2);,,("glDrawElements"))
...
GL_FUNCTION(GetTexGeniv, void, (GLenum coord, GLenum pname, GLint *params), (ARG1, ARG2, buffer), GLint buffer[1];, marshalBacki(cpu, ARG3, buffer, 1);,("glGetTexGeniv"))
GL_FUNCTION(GetTexEnvfv, void, (GLenum target, GLenum pname, GLfloat *params), (ARG1, ARG2, buffer), GLfloat buffer[1];, marshalBackf(cpu, ARG3, buffer, 1);,("glGetTexEnvfv"))
GL_FUNCTION(GetTexEnviv, void, (GLenum target, GLenum pname, GLint *params), (ARG1, ARG2, buffer), GLint buffer[1];, marshalBacki(cpu, ARG3, buffer, 1);,("glGetTexEnviv"))
GL_FUNCTION(GetTexParameterfv, void, (GLenum target, GLenum pname, GLfloat *params), (ARG1, ARG2, buffer), GLfloat buffer[1];, marshalBackf(cpu, ARG3, buffer, 1);,("glGetTexParameterfv"))
GL_FUNCTION(GetTexParameteriv, void, (GLenum target, GLenum pname, GLint *params), (ARG1, ARG2, buffer), GLint buffer[1];, marshalBacki(cpu, ARG3, buffer, 1);,("glGetTexParameteriv"))
...
GL_FUNCTION(FeedbackBuffer, void, (GLsizei size, GLenum type, GLfloat *buffer), (ARG1, ARG2, buffer), GLfloat* buffer = marshalf(cpu, ARG3, ARG1);, marshalBackf(cpu, ARG3, buffer, ARG1);,("glFeedbackBuffer"))
...
GL_FUNCTION(GetMaterialiv, void, (GLenum face, GLenum pname, GLint *params), (ARG1, ARG2, buffer), GLint* buffer = marshali(cpu, ARG3, glcommon_glMaterialv_size(ARG2));, marshalBacki(cpu, ARG3, buffer, glcommon_glMaterialv_size(ARG2));,("glGetMaterialiv"))
GL_FUNCTION(GetPixelMapfv, void, (GLenum map, GLfloat *values), (ARG1, buffer), GLfloat* buffer; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLfloat*)ARG2; else buffer = marshalf(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBackf(cpu, ARG2, buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapfv"))
GL_FUNCTION(GetPixelMapuiv, void, (GLenum map, GLuint *values), (ARG1, buffer), GLint* buffer; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLint*)ARG2; else buffer = marshali(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBacki(cpu, ARG2, buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapuiv"))
