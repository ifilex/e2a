/*
 ...
 $Log: pblHeap.c,v $
 Revision 1.8  2011/02/08 22:01:35  peter
 Removed some typos.

 Revision 1.7  2010/11/07 01:21:28  peter
 Cleanup.

 Revision 1.6  2010/10/19 20:20:57  peter
 ...
 */
char* pblHeap_c_id = "$Id: pblHeap.c,v 1.8 2011/02/08 22:01:35 peter Exp $";
 ...
 *
 * @return int rc >= 0: The size of the heap after the join.
 * @return int rc <  0: An error, see pbl_errno:
 *
 * <BR>PBL_ERROR_OUT_OF_MEMORY - Out of memory.
 */
