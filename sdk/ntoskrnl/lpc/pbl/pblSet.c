 ...
 */
char* pblSet_c_id = "$Id: pblSet.c,v 1.33 2015/03/23 15:53:10 peter Exp $";
...
PblSet * pblSetNewHashSet( void )
{
    ...
    pblSet->collection.magic = PblHashSetMagic;
