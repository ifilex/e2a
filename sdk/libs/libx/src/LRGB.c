...
static unsigned short const MASK[17] = {
     ...
     * to XcmsCIEXYZFormat.
     */
static XcmsConversionDDProc Fl_RGB_to_CIEXYZ[] = {
    XcmsRGBToRGBi,
    XcmsRGBiToCIEXYZ,
    NULL
};
     ...
     * to XcmsRGBFormat.
     */
static XcmsConversionDDProc Fl_CIEXYZ_to_RGB[] = {
    XcmsCIEXYZToRGBi,
    XcmsRGBiToRGB,
    NULL
};
     ...
     * to XcmsCIEXYZFormat.
     */
static XcmsConversionDDProc Fl_RGBi_to_CIEXYZ[] = {
    XcmsRGBiToCIEXYZ,
    NULL
};
     ...
     * to XcmsRGBiFormat.
     */
static XcmsConversionDDProc Fl_CIEXYZ_to_RGBi[] = {
    XcmsCIEXYZToRGBi,
    NULL
};
...
XcmsColorSpace	XcmsRGBiColorSpace =
	...
	(XcmsConversionProc *) Fl_RGBi_to_CIEXYZ,	/* to_CIEXYZ */
	(XcmsConversionProc *) Fl_CIEXYZ_to_RGBi,	/* from_CIEXYZ */
	1
    };
...
XcmsColorSpace	XcmsRGBColorSpace =
	...
	(XcmsConversionProc *) Fl_RGB_to_CIEXYZ,	/* to_CIEXYZ */
	(XcmsConversionProc *) Fl_CIEXYZ_to_RGB,	/* from_CIEXYZ */
	1
    };
