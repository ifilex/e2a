...
{
    XcmsColorSpace *pFrom, *pTo;
    XcmsConversionDDProc *src_to_CIEXYZ, *src_from_CIEXYZ;
    XcmsConversionDDProc *dest_to_CIEXYZ, *dest_from_CIEXYZ;
    XcmsConversionDDProc *from_CIEXYZ_start, *to_CIEXYZ_stop;
    XcmsConversionDDProc *tmp;
    int	retval;
    int hasCompressed = 0;
    ...
    src_to_CIEXYZ = (XcmsConversionDDProc *) pFrom->to_CIEXYZ;
    src_from_CIEXYZ = (XcmsConversionDDProc *) pFrom->from_CIEXYZ;
    dest_to_CIEXYZ = (XcmsConversionDDProc *) pTo->to_CIEXYZ;
    dest_from_CIEXYZ = (XcmsConversionDDProc *) pTo->from_CIEXYZ;
